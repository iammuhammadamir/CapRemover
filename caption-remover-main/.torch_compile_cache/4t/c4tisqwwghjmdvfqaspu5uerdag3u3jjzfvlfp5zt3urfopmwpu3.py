...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/h2/ch2wpklio4bh4fzglxkdpjoh5phm6rkluwx3btehbocuwbnlp7nc.py
...
def triton_(in_ptr0, out_ptr0, out_ptr1, out_ptr2, ks0, ks1, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        rmask = rindex < rnumel
        r2 = rindex
        tmp0 = r2 + (x1*((5 + (880*ks0*ks1)) // 6))
        tmp1 = 880*ks0*ks1
        tmp2 = tmp0 < tmp1
        tmp3 = tl.load(in_ptr0 + ((ks0*ks1*(((r2 + (x1*((5 + (880*ks0*ks1)) // 6))) // (22*ks0*ks1)) % 40)) + (40*ks0*ks1*x0) + (1280*ks0*ks1*(((r2 + (x1*((5 + (880*ks0*ks1)) // 6))) % (22*ks0*ks1)) // (ks0*ks1))) + (((r2 + (x1*((5 + (880*ks0*ks1)) // 6))) % (22*ks0*ks1)) % (ks0*ks1))), rmask & tmp2 & xmask, eviction_policy='evict_last', other=0.0).to(tl.float32)
...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/ft/cfto42vzyohcimbhppqcaan4slqxdhsqegaxmgl2rm2rsrd37os3.py
# Source Nodes: [hidden_states_2], Original ATen: [aten.native_group_norm]
# hidden_states_2 => convert_element_type, var_mean
...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/ns/cnsjbfi5qh4cowgqzuezkl7gch5hqqs62qd3c6ud2l3vbl3j4oab.py
# Source Nodes: [hidden_states_2], Original ATen: [aten.native_group_norm]
...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/jf/cjfsdohkuoy5s22vrerlq6ysxk3lbg72aenmuax4rkz4dyrod7y4.py
...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/by/cbyrgaxbruhgdbj6qf2v7jzmfcerydnkfvtq7j5cwtaw7665jpyf.py
...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/3a/c3adumvn7majvcm5g24jmqf56fvr2mw4r7i2kgzfv5qqyus6ptvy.py
...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/mv/cmvehoxryo7nu3pwmzxszepmh37uc3lfumj4wy2uagqylbtugbde.py
...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/ks/cks5ofjvjsurwsj2qjhlnidlmne3d3escosozk7ygpkquwlxeubo.py
...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/hv/chv5uvq5o5vqaqqrmgtuths55j3x7aop7grknjufvslt2pxqlljp.py
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        buf0 = empty_strided_cuda((1, 32, 1, 1, 6), (192, 1, 192, 192, 32), torch.float32)
        buf1 = empty_strided_cuda((1, 32, 1, 1, 6), (192, 1, 192, 192, 32), torch.float32)
        buf2 = empty_strided_cuda((1, 32, 1, 1, 6), (192, 1, 192, 192, 32), torch.float32)
        # Source Nodes: [hidden_states_2], Original ATen: [aten.native_group_norm]
        triton_red_fused_native_group_norm_0_rnumel = ((5 + (880*s1*s2)) // 6)
        stream0 = get_raw_stream(0)
        triton_red_fused_native_group_norm_0.run(arg29_1, buf0, buf1, buf2, s1, s2, 192, triton_red_fused_native_group_norm_0_rnumel, grid=grid(192), stream=stream0)
        buf3 = empty_strided_cuda((1, 32, 1, 1), (32, 1, 32, 32), torch.float32)
        buf4 = empty_strided_cuda((1, 32, 1, 1), (32, 1, 32, 32), torch.float32)
        # Source Nodes: [hidden_states_2], Original ATen: [aten.native_group_norm]
        triton_per_fused_native_group_norm_1.run(buf0, buf1, buf2, buf3, buf4, 32, 6, grid=grid(32), stream=stream0)
        del buf0
        del buf1
        del buf2
        ps0 = s1*s2
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg27_1 = 4
    arg28_1 = 12
    arg29_1 = rand_strided((22, 1280, 4, 12), (61440, 48, 12, 1), device='cuda:0', dtype=torch.float16)
