...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/di/cdiwu62gkovms3dph4kv6kpsie4pyaajodbz52jyxa5lkky7qu66.py
...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/iy/ciyfsulugpga4zp3pbvvlzczrw44vzvanxubxa4fjw5m4nebnduc.py
...
def call(args):
    ...
    assert_size_stride(arg2_1, (1280, 1920, 3, 3), (17280, 9, 3, 1))
    ...
    assert_size_stride(arg16_1, (1280, 1920, 1, 1), (1920, 1, 1, 1))
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg2_1 = rand_strided((1280, 1920, 3, 3), (17280, 9, 3, 1), device='cuda:0', dtype=torch.float16)
    ...
    arg16_1 = rand_strided((1280, 1920, 1, 1), (1920, 1, 1, 1), device='cuda:0', dtype=torch.float16)
    ...
    arg20_1 = 8
    arg21_1 = 23
    arg22_1 = rand_strided((22, 1920, 8, 23), (353280, 184, 23, 1), device='cuda:0', dtype=torch.float16)
