...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/b4/cb4edcsat5qpedfixbfqqlnwtrqggacjtpc76wycizabp7zvxn25.py
...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/cp/ccp4hb7vrp2rh2mz5rhoga3zfpu6qkx7iouq5apb7oxakflwt2r4.py
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        ps0 = s2*s3
        buf0 = empty_strided_cuda((22, 1280, s2, s3), (1280*s2*s3, s2*s3, s3, 1), torch.float16)
        # Source Nodes: [hidden_states], Original ATen: [aten._to_copy, aten._unsafe_index]
        triton_poi_fused__to_copy__unsafe_index_0_xnumel = 28160*s2*s3
        stream0 = get_raw_stream(0)
        triton_poi_fused__to_copy__unsafe_index_0.run(arg6_1, buf0, s2, s3, s0, s1, ps0, triton_poi_fused__to_copy__unsafe_index_0_xnumel, grid=grid(triton_poi_fused__to_copy__unsafe_index_0_xnumel), stream=stream0)
        del arg6_1
        ...
        assert_size_stride(buf1, (22, 1280, s2, s3), (1280*s2*s3, s2*s3, s3, 1))
        del arg0_1
        ...
        assert_size_stride(buf2, (22, 64, s2, s3), (64*s2*s3, s2*s3, s3, 1))
        del arg2_1
        del buf0
        ...
        assert_size_stride(buf3, (22, 1280, s2, s3), (1280*s2*s3, s2*s3, s3, 1))
        del arg3_1
        del buf2
        buf4 = buf1; del buf1  # reuse
        # Source Nodes: [mul, result, result_1], Original ATen: [aten.add, aten.convolution, aten.mul]
        triton_poi_fused_add_convolution_mul_1_xnumel = 28160*s2*s3
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg4_1 = 8
    arg5_1 = 23
    arg6_1 = rand_strided((22, 1280, 8, 23), (235520, 184, 23, 1), device='cuda:0', dtype=torch.float16)
    arg7_1 = 15
    arg8_1 = 45
