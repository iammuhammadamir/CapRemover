...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/u7/cu7hbprzja2rzrxl4cwxyo2ruuq4h5jyr5uw26dme5ciscydevqy.py
...
@triton_heuristics.reduction(
    ...
    filename=__file__,
    triton_meta={'signature': {0: '*fp16', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: 'i32', 5: 'i32'}, 'device': 0, 'device_type': 'cuda', 'constants': {}, 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4), equal_to_1=(), ids_of_folded_args=(), divisible_by_8=(4, 5))]},
...
def triton_(in_ptr0, out_ptr0, out_ptr1, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        rmask = rindex < rnumel
        r2 = rindex
        tmp0 = tl.load(in_ptr0 + ((2700*((r2 + (33000*x1)) // 59400)) + (27000*x0) + (864000*(((r2 + (33000*x1)) % 59400) // 2700)) + (((r2 + (33000*x1)) % 59400) % 2700)), rmask & xmask, eviction_policy='evict_last', other=0.0).to(tl.float32)
...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/r5/cr5z32c5wkxaopnojqio3s3loy3m2vtr3727e76nwwsegimbnefe.py
# Source Nodes: [hidden_states_2], Original ATen: [aten.native_group_norm]
# hidden_states_2 => add_1, convert_element_type_1, mul_1
...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/vz/cvzftkbrunyp62tixhvtepi6nyjcwrllstprt6knxqclx4a5jegx.py
...
# norm_hidden_states => add_3, add_4, convert_element_type_6, convert_element_type_7, mul_2, mul_3, rsqrt_1, sub_1, var_mean_1
...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/35/c35vim333k4mtuf2luvaf6cymof2juam7uwtrovov5bz7xto5o3k.py
...
# hidden_states_4 => add_2
# norm_hidden_states_2 => add_7, add_8, convert_element_type_17, convert_element_type_18, mul_4, mul_5, rsqrt_2, sub_2, var_mean_2
...
@triton_heuristics.persistent_reduction(
    ...
    reduction_hint=ReductionHint.INNER,
    filename=__file__,
    triton_meta={'signature': {0: '*fp16', 1: '*fp16', 2: '*fp16', 3: '*fp16', 4: '*fp16', 5: '*fp16', 6: '*fp16', 7: '*fp16', 8: 'i32', 9: 'i32'}, 'device': 0, 'device_type': 'cuda', 'constants': {}, 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7, 9), equal_to_1=(), ids_of_folded_args=(), divisible_by_8=(8, 9))]},
...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/yb/cyb6lxsl7htifjqklc7kuympnx2q2yamkjfuv6uetfto2tanpqr7.py
...
# hidden_states_4 => add_2
# norm_hidden_states_4 => add_11, add_12, convert_element_type_28, convert_element_type_29, mul_6, mul_7, rsqrt_3, sub_3, var_mean_3
...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/jw/cjwjed22iptbz4dqfbfyn3cxvaw2eopgbfiqa4w4zna5t4q5mnqq.py
# Source Nodes: [gelu, hidden_states_21], Original ATen: [aten.gelu, aten.mul]
# gelu => add_13, convert_element_type_33, convert_element_type_34, erf, mul_10, mul_8, mul_9
...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/py/cpy3jtztsxbrd4vhzaphnjlokj2fgluh4vcruk2ulraznxutiqej.py
...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/x7/cx7ckqfutqse3ilr2z62el5q32t7bwenw24l2vqyqcz2dwwtd4wo.py
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {0: '*fp16', 1: '*fp16', 2: '*fp16', 3: '*fp16', 4: 'i32', 5: 'i32'}, 'device': 0, 'device_type': 'cuda', 'constants': {}, 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4), equal_to_1=(), ids_of_folded_args=(), divisible_by_8=(4,))]},
...
def triton_(in_ptr0, in_ptr1, in_ptr2, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    tmp3 = tl.load(in_ptr2 + (x2 + (2700*y3)), xmask & ymask, eviction_policy='evict_last').to(tl.float32)
    tmp2 = tmp0 + tmp1
    tmp4 = tmp2 + tmp3
    tl.store(out_ptr0 + (x2 + (2700*y3)), tmp4, xmask & ymask)
''', device_str='cuda')
...
def call(args):
    ...
    assert_size_stride(arg27_1, (22, 320, 30, 90), (864000, 2700, 90, 1))
    with torch.cuda._DeviceGuard(0):
        ...
        triton_red_fused_native_group_norm_0.run(arg27_1, buf0, buf1, buf2, 576, 33000, grid=grid(576), stream=stream0)
        ...
        del buf1
        del buf2
        buf6 = empty_strided_cuda((1, 320, 22, 30, 90), (19008000, 59400, 2700, 90, 1), torch.float16)
        # Source Nodes: [hidden_states_2], Original ATen: [aten.native_group_norm]
        triton_poi_fused_native_group_norm_2.run(arg27_1, buf3, buf4, arg0_1, arg1_1, buf6, 19008000, grid=grid(19008000), stream=stream0)
        del arg0_1
        del arg1_1
        del buf3
        del buf4
        buf7 = empty_strided_cuda((2700, 22, 320), (7040, 320, 1), torch.float16)
        # Source Nodes: [hidden_states_4], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf6, (2700, 22, 320), (1, 2700, 59400), 0), reinterpret_tensor(arg2_1, (2700, 320, 320), (0, 1, 320), 0), out=buf7)
        del arg2_1
        buf11 = reinterpret_tensor(buf6, (2700, 22, 320), (7040, 320, 1), 0); del buf6  # reuse
        # Source Nodes: [encoder_hidden_states, hidden_states_4, norm_hidden_states], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_3.run(buf7, arg3_1, arg4_1, arg5_1, arg26_1, buf11, 59400, 320, grid=grid(59400), stream=stream0)
        del arg4_1
        del arg5_1
        buf12 = empty_strided_cuda((59400, 320), (320, 1), torch.float16)
        # Source Nodes: [query], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf11, (59400, 320), (320, 1), 0), reinterpret_tensor(arg6_1, (320, 320), (1, 320), 0), out=buf12)
        del arg6_1
        buf13 = empty_strided_cuda((59400, 320), (320, 1), torch.float16)
        # Source Nodes: [key], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf11, (59400, 320), (320, 1), 0), reinterpret_tensor(arg7_1, (320, 320), (1, 320), 0), out=buf13)
        del arg7_1
        buf14 = empty_strided_cuda((59400, 320), (320, 1), torch.float16)
        # Source Nodes: [value], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf11, (59400, 320), (320, 1), 0), reinterpret_tensor(arg8_1, (320, 320), (1, 320), 0), out=buf14)
        del arg8_1
        # Source Nodes: [hidden_states_5], Original ATen: [aten._scaled_dot_product_flash_attention]
        buf15 = aten._scaled_dot_product_flash_attention.default(reinterpret_tensor(buf12, (2700, 8, 22, 40), (7040, 40, 320, 1), 0), reinterpret_tensor(buf13, (2700, 8, 22, 40), (7040, 40, 320, 1), 0), reinterpret_tensor(buf14, (2700, 8, 22, 40), (7040, 40, 320, 1), 0), scale=0.15811388300841897)
        buf16 = buf15[0]
        del buf15
        buf21 = buf14; del buf14  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf16, (59400, 320), (320, 1), 0), reinterpret_tensor(arg9_1, (320, 320), (1, 320), 0), out=buf21)
        del arg9_1
        buf25 = reinterpret_tensor(buf16, (2700, 22, 320), (7040, 320, 1), 0); del buf16  # reuse
        # Source Nodes: [attn_output, encoder_hidden_states_1, hidden_states_11, hidden_states_4, norm_hidden_states_2], Original ATen: [aten.add, aten.div, aten.native_layer_norm]
        triton_per_fused_add_div_native_layer_norm_4.run(buf21, arg10_1, buf7, arg3_1, arg11_1, arg12_1, arg26_1, buf25, 59400, 320, grid=grid(59400), stream=stream0)
        del arg11_1
        del arg12_1
        del arg26_1
        buf26 = buf13; del buf13  # reuse
        # Source Nodes: [query_2], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf25, (59400, 320), (320, 1), 0), reinterpret_tensor(arg13_1, (320, 320), (1, 320), 0), out=buf26)
        del arg13_1
        buf27 = buf12; del buf12  # reuse
        # Source Nodes: [key_2], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf25, (59400, 320), (320, 1), 0), reinterpret_tensor(arg14_1, (320, 320), (1, 320), 0), out=buf27)
        del arg14_1
        buf28 = reinterpret_tensor(buf11, (59400, 320), (320, 1), 0); del buf11  # reuse
        # Source Nodes: [value_2], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf25, (59400, 320), (320, 1), 0), reinterpret_tensor(arg15_1, (320, 320), (1, 320), 0), out=buf28)
        del arg15_1
        del buf25
        # Source Nodes: [hidden_states_12], Original ATen: [aten._scaled_dot_product_flash_attention]
        buf29 = aten._scaled_dot_product_flash_attention.default(reinterpret_tensor(buf26, (2700, 8, 22, 40), (7040, 40, 320, 1), 0), reinterpret_tensor(buf27, (2700, 8, 22, 40), (7040, 40, 320, 1), 0), reinterpret_tensor(buf28, (2700, 8, 22, 40), (7040, 40, 320, 1), 0), scale=0.15811388300841897)
        del buf26
        del buf27
        buf30 = buf29[0]
        del buf29
        ...
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf30, (59400, 320), (320, 1), 0), reinterpret_tensor(arg16_1, (320, 320), (1, 320), 0), out=buf35)
        del arg16_1
        buf36 = reinterpret_tensor(buf35, (2700, 22, 320), (7040, 320, 1), 0); del buf35  # reuse
        buf40 = reinterpret_tensor(buf30, (2700, 22, 320), (7040, 320, 1), 0); del buf30  # reuse
        # Source Nodes: [attn_output, attn_output_1, hidden_states_11, hidden_states_18, hidden_states_4, norm_hidden_states_4], Original ATen: [aten.add, aten.div, aten.native_layer_norm]
        triton_per_fused_add_div_native_layer_norm_5.run(buf36, arg17_1, buf21, arg10_1, buf7, arg3_1, arg18_1, arg19_1, buf40, 59400, 320, grid=grid(59400), stream=stream0)
        del arg10_1
        del arg17_1
        del arg18_1
        del arg19_1
        ...
        del buf21
        del buf7
        buf41 = empty_strided_cuda((59400, 2560), (2560, 1), torch.float16)
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf40, (59400, 320), (320, 1), 0), reinterpret_tensor(arg20_1, (320, 2560), (1, 320), 0), out=buf41)
        del arg20_1
        buf42 = empty_strided_cuda((2700, 22, 1280), (28160, 1280, 1), torch.float16)
        # Source Nodes: [gelu, hidden_states_21], Original ATen: [aten.gelu, aten.mul]
        triton_poi_fused_gelu_mul_6.run(buf41, arg21_1, buf42, 76032000, grid=grid(76032000), stream=stream0)
        del arg21_1
        del buf41
        buf43 = reinterpret_tensor(buf40, (59400, 320), (320, 1), 0); del buf40  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf42, (59400, 1280), (1280, 1), 0), reinterpret_tensor(arg22_1, (1280, 320), (1, 1280), 0), out=buf43)
        del arg22_1
        del buf42
        buf44 = reinterpret_tensor(buf43, (2700, 22, 320), (7040, 320, 1), 0); del buf43  # reuse
        # Source Nodes: [hidden_states_25], Original ATen: [aten.add]
        triton_poi_fused_add_7.run(buf44, arg23_1, buf36, 19008000, grid=grid(19008000), stream=stream0)
        del arg23_1
        buf45 = reinterpret_tensor(buf36, (59400, 320), (320, 1), 0); del buf36  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf44, (59400, 320), (320, 1), 0), reinterpret_tensor(arg24_1, (320, 320), (1, 320), 0), out=buf45)
        del arg24_1
        buf46 = reinterpret_tensor(buf44, (22, 320, 30, 90), (864000, 2700, 90, 1), 0); del buf44  # reuse
        # Source Nodes: [output], Original ATen: [aten.add]
        triton_poi_fused_add_8.run(buf45, arg25_1, arg27_1, buf46, 7040, 2700, grid=grid(7040, 2700), stream=stream0)
        del arg25_1
        del arg27_1
        del buf45
    return (buf46, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg27_1 = rand_strided((22, 320, 30, 90), (864000, 2700, 90, 1), device='cuda:0', dtype=torch.float16)
