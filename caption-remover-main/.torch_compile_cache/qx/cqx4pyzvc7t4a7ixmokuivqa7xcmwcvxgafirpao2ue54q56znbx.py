...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/p2/cp2xiwomhq4r44doft3p5d3rwxi2cr7fzvwusa2fo3jotyz4ejdj.py
...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/ht/chtvn2kbod2ie6daflrevpofrzdol33w6pj5xcxvmqvofwuired3.py
...
def call(args):
    ...
    assert_size_stride(arg2_1, (1280, 640, 3, 3), (5760, 9, 3, 1))
    ...
    assert_size_stride(arg16_1, (1280, 640, 1, 1), (640, 1, 1, 1))
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg2_1 = rand_strided((1280, 640, 3, 3), (5760, 9, 3, 1), device='cuda:0', dtype=torch.float16)
    ...
    arg16_1 = rand_strided((1280, 640, 1, 1), (640, 1, 1, 1), device='cuda:0', dtype=torch.float16)
    ...
    arg20_1 = 8
    arg21_1 = 23
    arg22_1 = rand_strided((22, 640, 8, 23), (117760, 184, 23, 1), device='cuda:0', dtype=torch.float16)
