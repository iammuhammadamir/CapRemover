...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/ip/cipvgqj2nxjqbzdejrswjgycift5rrv4qgwnaxqnojbbrex6g4fk.py
...
def triton_(in_ptr0, out_ptr0, out_ptr1, ks0, ks1, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        rmask = rindex < rnumel
        r1 = rindex
        tmp0 = tl.load(in_ptr0 + (r1 + (10*ks0*ks1*x0)), rmask & xmask, eviction_policy='evict_first', other=0.0).to(tl.float32)
...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/ur/curlgtddqnhoxwxtcfpavnptzdxanq2ntksrnld774bjxp2plsx3.py
# Source Nodes: [hidden_states], Original ATen: [aten.native_group_norm]
...
def triton_(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, ks0, ks1, ks2, ks3, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp2 = tl.load(in_ptr1 + ((32*x2) + (x1 // 10)), xmask, eviction_policy='evict_last')
    tmp4 = tl.load(in_ptr2 + ((32*x2) + (x1 // 10)), xmask, eviction_policy='evict_last')
...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/3k/c3ktaxvojbasijh3jdxafl3ojn3hdusjlhbwixjzuuzus4du6imy.py
...
def triton_(in_ptr0, in_ptr1, in_ptr2, out_ptr0, out_ptr1, ks0, ks1, ks2, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        rmask = rindex < rnumel
        r2 = rindex
        tmp0 = tl.load(in_ptr0 + (x0 + (ks1*ks2*r2) + (320*ks1*ks2*x1)), rmask & xmask, eviction_policy='evict_last', other=0.0).to(tl.float32)
        tmp1 = tl.load(in_ptr1 + (r2), rmask, eviction_policy='evict_last', other=0.0).to(tl.float32)
        tmp3 = tl.load(in_ptr2 + (x0 + (ks1*ks2*r2) + (320*ks1*ks2*x1)), rmask & xmask, eviction_policy='evict_last', other=0.0).to(tl.float32)
        tmp2 = tmp0 + tmp1
        tmp4 = 0.125
        tmp5 = tmp3 * tmp4
        tmp6 = tmp2 + tmp5
...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/nl/cnllm3oc7rtnolgg5bmcbrgs6a6rkbo3fwagcuoktdxls2gqramn.py
# Source Nodes: [encoder_hidden_states], Original ATen: [aten.native_layer_norm]
...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/ww/cww4gnmmyoqy6735rntks275lfel3i4zuzmq7efjp6ssby62pwdn.py
...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/6v/c6vthtidirwmzeduiimqylhggrxlqnfmsrs2mg7u7apejvsgjmgi.py
...
def triton_(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, in_ptr6, out_ptr2, ks0, ks1, ks2, xnumel, rnumel):
    ...
    x0 = xindex % ks0
    x1 = (xindex // ks0)
    tmp0 = tl.load(in_out_ptr0 + (r2 + (320*x3)), rmask & xmask, other=0.0).to(tl.float32)
    tmp1 = tl.load(in_ptr0 + (r2), rmask, eviction_policy='evict_last', other=0.0).to(tl.float32)
    tmp3 = tl.load(in_ptr1 + (r2 + (320*x3)), rmask & xmask, other=0.0).to(tl.float32)
    tmp9 = tl.load(in_ptr2 + (x0 + (ks1*ks2*r2) + (320*ks1*ks2*x1)), rmask & xmask, eviction_policy='evict_last', other=0.0).to(tl.float32)
    tmp10 = tl.load(in_ptr3 + (r2), rmask, eviction_policy='evict_last', other=0.0).to(tl.float32)
    tmp12 = tl.load(in_ptr4 + (x0 + (ks1*ks2*r2) + (320*ks1*ks2*x1)), rmask & xmask, eviction_policy='evict_last', other=0.0).to(tl.float32)
    ...
    tl.store(in_out_ptr0 + (r2 + (320*x3)), tmp15, rmask & xmask)
    tl.store(out_ptr2 + (r2 + (320*x3)), tmp46, rmask & xmask)
''', device_str='cuda')


# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/u5/cu5citeiyxwk6c3lxts4yhnr6aaff55gsbh6ccpy4rd4ae3m2s4p.py
...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/jx/cjxymd7vuo76f5ebthlo7otyindlqftn3vnjbtklqrjrg2bf4pml.py
...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/fr/cfr2obw4bsbmxazzh44edl2pawpvjhvgy2hmqbtitxrpethvbuix.py
...
def triton_(in_ptr0, in_ptr1, in_ptr2, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp3 = tl.load(in_ptr2 + (x0 + (2560*x1)), xmask).to(tl.float32)
    tmp7 = tl.load(in_ptr0 + (1280 + x0 + (2560*x1)), xmask).to(tl.float32)
    tmp8 = tl.load(in_ptr1 + (1280 + x0), xmask, eviction_policy='evict_last').to(tl.float32)
    tmp10 = tl.load(in_ptr2 + (1280 + x0 + (2560*x1)), xmask).to(tl.float32)
    tmp2 = tmp0 + tmp1
    tmp4 = 0.125
    tmp5 = tmp3 * tmp4
    tmp6 = tmp2 + tmp5
...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/jq/cjqlvsnd5srvsisb5xahkilomuymdcyos2rtziv2oc6khxsqi43w.py
...
def triton_(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, in_ptr6, out_ptr0, ks0, ks1, ks2, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    tmp7 = tl.load(in_ptr3 + (x2 + (320*y3)), xmask & ymask, eviction_policy='evict_last').to(tl.float32)
    tmp8 = tl.load(in_ptr4 + (x2), xmask, eviction_policy='evict_last').to(tl.float32)
    tmp10 = tl.load(in_ptr5 + (x2 + (320*y3)), xmask & ymask, eviction_policy='evict_last').to(tl.float32)
    tmp15 = tl.load(in_ptr6 + (x2 + (320*y3)), xmask & ymask, eviction_policy='evict_last').to(tl.float32)
    tmp2 = tmp0 + tmp1
    tmp4 = 0.125
    tmp5 = tmp3 * tmp4
    tmp6 = tmp2 + tmp5
    ...
    tmp16 = tmp14 + tmp15
    tmp17 = tmp6 + tmp16
    tl.store(out_ptr0 + (y0 + (ks1*ks2*x2) + (320*ks1*ks2*y1)), tmp17, xmask & ymask)
''', device_str='cuda')


# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/vx/cvxkzgnwysdh422dln3sstq6dma237llctlzpvdjxk7ntxewd6ys.py
...
def call(args):
    ...
    assert_size_stride(arg52_1, (22, 320, s1, s2), (320*s1*s2, s1*s2, s2, 1))
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        # Source Nodes: [hidden_states], Original ATen: [aten.native_group_norm]
        triton_red_fused_native_group_norm_0_rnumel = 10*s1*s2
        ...
        ps0 = s1*s2
        ps1 = 320*s1*s2
        buf3 = empty_strided_cuda((22, 320, s1, s2), (320*s1*s2, s1*s2, s2, 1), torch.float16)
        # Source Nodes: [hidden_states], Original ATen: [aten.native_group_norm]
        triton_poi_fused_native_group_norm_1_xnumel = 7040*s1*s2
        ...
        assert_size_stride(buf4, (22, 320, s1, s2), (320*s1*s2, s1*s2, s2, 1))
        del arg2_1
        ...
        assert_size_stride(buf6, (22, 320, s1, s2), (320*s1*s2, s1*s2, s2, 1))
        del arg5_1
        ...
        triton_red_fused_native_layer_norm_2.run(buf4, arg3_1, buf6, buf7, buf8, ps0, s1, s2, triton_red_fused_native_layer_norm_2_xnumel, 320, grid=grid(triton_red_fused_native_layer_norm_2_xnumel), stream=stream0)
        buf10 = reinterpret_tensor(buf3, (22, s1*s2, 320), (320*s1*s2, 320, 1), 0); del buf3  # reuse
        # Source Nodes: [encoder_hidden_states], Original ATen: [aten.native_layer_norm]
        triton_poi_fused_native_layer_norm_3_xnumel = s1*s2
        triton_poi_fused_native_layer_norm_3.run(buf4, arg3_1, buf6, buf7, buf8, arg6_1, arg7_1, buf10, s1, s2, 7040, triton_poi_fused_native_layer_norm_3_xnumel, grid=grid(7040, triton_poi_fused_native_layer_norm_3_xnumel), stream=stream0)
        del arg6_1
        del arg7_1
        del buf7
        del buf8
        buf11 = empty_strided_cuda((22*s1*s2, 320), (320, 1), torch.float16)
        # Source Nodes: [result_3], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf10, (22*s1*s2, 320), (320, 1), 0), reinterpret_tensor(arg8_1, (320, 320), (1, 320), 0), out=buf11)
        del arg8_1
        ...
        extern_kernels.mm(reinterpret_tensor(buf10, (22*s1*s2, 320), (320, 1), 0), reinterpret_tensor(arg9_1, (320, 64), (1, 320), 0), out=buf12)
        del arg9_1
        ...
        extern_kernels.mm(reinterpret_tensor(buf12, (22*s1*s2, 64), (64, 1), 0), reinterpret_tensor(arg10_1, (64, 320), (1, 64), 0), out=buf13)
        del arg10_1
        buf14 = empty_strided_cuda((22*s1*s2, 320), (320, 1), torch.float16)
        # Source Nodes: [result_6], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf10, (22*s1*s2, 320), (320, 1), 0), reinterpret_tensor(arg11_1, (320, 320), (1, 320), 0), out=buf14)
        del arg11_1
        buf15 = buf12; del buf12  # reuse
        # Source Nodes: [l__self___transformer_blocks_0_attn1_to_k_lora_a_default_0], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf10, (22*s1*s2, 320), (320, 1), 0), reinterpret_tensor(arg12_1, (320, 64), (1, 320), 0), out=buf15)
        del arg12_1
        buf16 = empty_strided_cuda((22*s1*s2, 320), (320, 1), torch.float16)
        # Source Nodes: [l__self___transformer_blocks_0_attn1_to_k_lora_b_default_0], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf15, (22*s1*s2, 64), (64, 1), 0), reinterpret_tensor(arg13_1, (64, 320), (1, 64), 0), out=buf16)
        del arg13_1
        buf17 = empty_strided_cuda((22*s1*s2, 320), (320, 1), torch.float16)
        # Source Nodes: [result_9], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf10, (22*s1*s2, 320), (320, 1), 0), reinterpret_tensor(arg14_1, (320, 320), (1, 320), 0), out=buf17)
        del arg14_1
        buf18 = buf15; del buf15  # reuse
        # Source Nodes: [l__self___transformer_blocks_0_attn1_to_v_lora_a_default_0], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf10, (22*s1*s2, 320), (320, 1), 0), reinterpret_tensor(arg15_1, (320, 64), (1, 320), 0), out=buf18)
        del arg15_1
        buf19 = reinterpret_tensor(buf10, (22*s1*s2, 320), (320, 1), 0); del buf10  # reuse
        # Source Nodes: [l__self___transformer_blocks_0_attn1_to_v_lora_b_default_0], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf18, (22*s1*s2, 64), (64, 1), 0), reinterpret_tensor(arg16_1, (64, 320), (1, 64), 0), out=buf19)
        del arg16_1
        buf20 = reinterpret_tensor(buf11, (22, 8, s1*s2, 40), (320*s1*s2, 40, 320, 1), 0); del buf11  # reuse
        # Source Nodes: [hidden_states_4], Original ATen: [aten._scaled_dot_product_flash_attention]
        triton_poi_fused__scaled_dot_product_flash_attention_4_xnumel = 7040*s1*s2
        ...
        del buf13
        buf21 = reinterpret_tensor(buf14, (22, 8, s1*s2, 40), (320*s1*s2, 40, 320, 1), 0); del buf14  # reuse
        # Source Nodes: [hidden_states_4], Original ATen: [aten._scaled_dot_product_flash_attention]
        triton_poi_fused__scaled_dot_product_flash_attention_4_xnumel = 7040*s1*s2
        ...
        del buf16
        buf22 = reinterpret_tensor(buf17, (22, 8, s1*s2, 40), (320*s1*s2, 40, 320, 1), 0); del buf17  # reuse
        # Source Nodes: [hidden_states_4], Original ATen: [aten._scaled_dot_product_flash_attention]
        triton_poi_fused__scaled_dot_product_flash_attention_4_xnumel = 7040*s1*s2
        ...
        buf24 = buf23[0]
        del buf23
        buf29 = reinterpret_tensor(buf22, (22*s1*s2, 320), (320, 1), 0); del buf22  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf24, (22*s1*s2, 320), (320, 1), 0), reinterpret_tensor(arg17_1, (320, 320), (1, 320), 0), out=buf29)
        del arg17_1
        ...
        extern_kernels.mm(reinterpret_tensor(buf24, (22*s1*s2, 320), (320, 1), 0), reinterpret_tensor(arg19_1, (320, 64), (1, 320), 0), out=buf30)
        del arg19_1
        buf31 = reinterpret_tensor(buf24, (22*s1*s2, 320), (320, 1), 0); del buf24  # reuse
        # Source Nodes: [l__self___transformer_blocks_0_attn1_to_out_0_lora_b_default_0], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf30, (22*s1*s2, 64), (64, 1), 0), reinterpret_tensor(arg20_1, (64, 320), (1, 64), 0), out=buf31)
        del arg20_1
        buf32 = reinterpret_tensor(buf29, (22, s1*s2, 320), (320*s1*s2, 320, 1), 0); del buf29  # reuse
        buf36 = reinterpret_tensor(buf21, (22, s1*s2, 320), (320*s1*s2, 320, 1), 0); del buf21  # reuse
        # Source Nodes: [attn_output, hidden_states_10, mul_5, residual_2, result_13], Original ATen: [aten.add, aten.div, aten.mul, aten.native_layer_norm]
        triton_per_fused_add_div_mul_native_layer_norm_5_xnumel = 22*s1*s2
        triton_per_fused_add_div_mul_native_layer_norm_5.run(buf32, arg18_1, buf31, buf4, arg3_1, buf6, arg21_1, arg22_1, buf36, ps0, s1, s2, triton_per_fused_add_div_mul_native_layer_norm_5_xnumel, 320, grid=grid(triton_per_fused_add_div_mul_native_layer_norm_5_xnumel), stream=stream0)
        del arg18_1
        del arg21_1
        del arg22_1
        del arg3_1
        buf37 = reinterpret_tensor(buf6, (22*s1*s2, 320), (320, 1), 0); del buf6  # reuse
        # Source Nodes: [result_15], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf36, (22*s1*s2, 320), (320, 1), 0), reinterpret_tensor(arg23_1, (320, 320), (1, 320), 0), out=buf37)
        del arg23_1
        buf38 = buf30; del buf30  # reuse
        # Source Nodes: [l__self___transformer_blocks_0_attn2_to_q_lora_a_default_0], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf36, (22*s1*s2, 320), (320, 1), 0), reinterpret_tensor(arg24_1, (320, 64), (1, 320), 0), out=buf38)
        del arg24_1
        buf39 = reinterpret_tensor(buf36, (22*s1*s2, 320), (320, 1), 0); del buf36  # reuse
        # Source Nodes: [l__self___transformer_blocks_0_attn2_to_q_lora_b_default_0], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf38, (22*s1*s2, 64), (64, 1), 0), reinterpret_tensor(arg25_1, (64, 320), (1, 64), 0), out=buf39)
        del arg25_1
        buf40 = empty_strided_cuda((1694, 320), (320, 1), torch.float16)
        # Source Nodes: [result_18], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(arg53_1, (1694, 768), (768, 1), 0), reinterpret_tensor(arg26_1, (768, 320), (1, 768), 0), out=buf40)
        del arg26_1
        ...
        extern_kernels.mm(reinterpret_tensor(arg53_1, (1694, 768), (768, 1), 0), reinterpret_tensor(arg29_1, (768, 320), (1, 768), 0), out=buf43)
        del arg29_1
        ...
        del arg31_1
        del buf44
        buf46 = reinterpret_tensor(buf37, (22, 8, s1*s2, 40), (320*s1*s2, 40, 320, 1), 0); del buf37  # reuse
        # Source Nodes: [hidden_states_11], Original ATen: [aten._scaled_dot_product_flash_attention]
        triton_poi_fused__scaled_dot_product_flash_attention_4_xnumel = 7040*s1*s2
        ...
        # Source Nodes: [hidden_states_11], Original ATen: [aten._scaled_dot_product_flash_attention]
        triton_poi_fused__scaled_dot_product_flash_attention_6.run(buf47, buf42, 542080, grid=grid(542080), stream=stream0)
        del buf42
        buf48 = reinterpret_tensor(buf43, (22, 8, 77, 40), (24640, 40, 320, 1), 0); del buf43  # reuse
        # Source Nodes: [hidden_states_11], Original ATen: [aten._scaled_dot_product_flash_attention]
        triton_poi_fused__scaled_dot_product_flash_attention_6.run(buf48, buf45, 542080, grid=grid(542080), stream=stream0)
        del buf45
        # Source Nodes: [hidden_states_11], Original ATen: [aten._scaled_dot_product_flash_attention]
        ...
        buf50 = buf49[0]
        del buf49
        buf55 = reinterpret_tensor(buf46, (22*s1*s2, 320), (320, 1), 0); del buf46  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf50, (22*s1*s2, 320), (320, 1), 0), reinterpret_tensor(arg32_1, (320, 320), (1, 320), 0), out=buf55)
        del arg32_1
        ...
        extern_kernels.mm(reinterpret_tensor(buf50, (22*s1*s2, 320), (320, 1), 0), reinterpret_tensor(arg34_1, (320, 64), (1, 320), 0), out=buf56)
        del arg34_1
        buf57 = reinterpret_tensor(buf50, (22*s1*s2, 320), (320, 1), 0); del buf50  # reuse
        # Source Nodes: [l__self___transformer_blocks_0_attn2_to_out_0_lora_b_default_0], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf56, (22*s1*s2, 64), (64, 1), 0), reinterpret_tensor(arg35_1, (64, 320), (1, 64), 0), out=buf57)
        del arg35_1
        buf61 = reinterpret_tensor(buf39, (22, s1*s2, 320), (320*s1*s2, 320, 1), 0); del buf39  # reuse
        # Source Nodes: [attn_output_1, hidden_states_17, mul_9, norm_hidden_states_2, result_25], Original ATen: [aten.add, aten.div, aten.mul, aten.native_layer_norm]
        triton_per_fused_add_div_mul_native_layer_norm_7_xnumel = 22*s1*s2
        triton_per_fused_add_div_mul_native_layer_norm_7.run(buf55, arg33_1, buf57, buf32, arg36_1, arg37_1, buf61, triton_per_fused_add_div_mul_native_layer_norm_7_xnumel, 320, grid=grid(triton_per_fused_add_div_mul_native_layer_norm_7_xnumel), stream=stream0)
        del arg36_1
        del arg37_1
        buf62 = empty_strided_cuda((22*s1*s2, 2560), (2560, 1), torch.float16)
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf61, (22*s1*s2, 320), (320, 1), 0), reinterpret_tensor(arg38_1, (320, 2560), (1, 320), 0), out=buf62)
        del arg38_1
        ...
        extern_kernels.mm(reinterpret_tensor(buf61, (22*s1*s2, 320), (320, 1), 0), reinterpret_tensor(arg40_1, (320, 64), (1, 320), 0), out=buf63)
        del arg40_1
        buf64 = empty_strided_cuda((22*s1*s2, 2560), (2560, 1), torch.float16)
        # Source Nodes: [l__self___transformer_blocks_0_ff_net_0_proj_lora_b_default_0], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf63, (22*s1*s2, 64), (64, 1), 0), reinterpret_tensor(arg41_1, (64, 2560), (1, 64), 0), out=buf64)
        del arg41_1
        buf65 = empty_strided_cuda((22, s1*s2, 1280), (1280*s1*s2, 1280, 1), torch.float16)
        # Source Nodes: [gelu, hidden_states_20], Original ATen: [aten.gelu, aten.mul]
        triton_poi_fused_gelu_mul_8_xnumel = 28160*s1*s2
        ...
        del buf62
        del buf64
        buf66 = reinterpret_tensor(buf61, (22*s1*s2, 320), (320, 1), 0); del buf61  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf65, (22*s1*s2, 1280), (1280, 1), 0), reinterpret_tensor(arg42_1, (1280, 320), (1, 1280), 0), out=buf66)
        del arg42_1
        buf67 = buf63; del buf63  # reuse
        # Source Nodes: [l__self___transformer_blocks_0_ff_net_2_lora_a_default_0], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf65, (22*s1*s2, 1280), (1280, 1), 0), reinterpret_tensor(arg44_1, (1280, 64), (1, 1280), 0), out=buf67)
        del arg44_1
        del buf65
        buf68 = reinterpret_tensor(buf4, (22*s1*s2, 320), (320, 1), 0); del buf4  # reuse
        # Source Nodes: [l__self___transformer_blocks_0_ff_net_2_lora_b_default_0], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf67, (22*s1*s2, 64), (64, 1), 0), reinterpret_tensor(arg45_1, (64, 320), (1, 64), 0), out=buf68)
        del arg45_1
        del buf67
        buf69 = reinterpret_tensor(buf31, (22, 320, s1, s2), (320*s1*s2, s1*s2, s2, 1), 0); del buf31  # reuse
        # Source Nodes: [hidden_states_25], Original ATen: [aten.clone]
        triton_poi_fused_clone_9_ynumel = 22*s1*s2
        triton_poi_fused_clone_9.run(buf66, arg43_1, buf68, buf55, arg33_1, buf57, buf32, buf69, ps0, s1, s2, triton_poi_fused_clone_9_ynumel, 320, grid=grid(triton_poi_fused_clone_9_ynumel, 320), stream=stream0)
        del arg33_1
        del arg43_1
        del buf32
        del buf55
        ...
        assert_size_stride(buf70, (22, 320, s1, s2), (320*s1*s2, s1*s2, s2, 1))
        del arg46_1
        ...
        assert_size_stride(buf72, (22, 320, s1, s2), (320*s1*s2, s1*s2, s2, 1))
        del arg49_1
        del buf71
        buf73 = buf70; del buf70  # reuse
        # Source Nodes: [mul_13, output, result_33, result_34], Original ATen: [aten.add, aten.convolution, aten.mul]
        triton_poi_fused_add_convolution_mul_10_xnumel = 7040*s1*s2
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg50_1 = 30
    arg51_1 = 90
    arg52_1 = rand_strided((22, 320, 30, 90), (864000, 2700, 90, 1), device='cuda:0', dtype=torch.float16)
