...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/wo/cwozeefakhb4mlm5yclmuxvrmxyidmmizcgnsoavhsho3skrn2g3.py
...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/6u/c6udyyuzc4onrk7hw4w3orudv65zfphfww5ekyxvcgiwqtnbhks3.py
...
def call(args):
    ...
    assert_size_stride(arg2_1, (640, 1280, 3, 3), (11520, 9, 3, 1))
    assert_size_stride(arg3_1, (640, ), (1, ))
    assert_size_stride(arg4_1, (64, 1280, 3, 3), (11520, 9, 3, 1))
    ...
    assert_size_stride(arg16_1, (640, 1280, 1, 1), (1280, 1, 1, 1))
    assert_size_stride(arg17_1, (640, ), (1, ))
    assert_size_stride(arg18_1, (64, 1280, 1, 1), (1280, 1, 1, 1))
    assert_size_stride(arg19_1, (640, 64, 1, 1), (64, 1, 1, 1))
    assert_size_stride(arg22_1, (22, 1280, s1, s2), (1280*s1*s2, s1*s2, s2, 1))
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        ps0 = s1*s2
        ps1 = 1280*s1*s2
        buf4 = empty_strided_cuda((22, 1280, s1, s2), (1280*s1*s2, s1*s2, s2, 1), torch.float16)
        # Source Nodes: [hidden_states_1, hidden_states_2], Original ATen: [aten.native_group_norm, aten.silu]
        triton_poi_fused_native_group_norm_silu_1_xnumel = 28160*s1*s2
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg2_1 = rand_strided((640, 1280, 3, 3), (11520, 9, 3, 1), device='cuda:0', dtype=torch.float16)
    arg3_1 = rand_strided((640, ), (1, ), device='cuda:0', dtype=torch.float16)
    arg4_1 = rand_strided((64, 1280, 3, 3), (11520, 9, 3, 1), device='cuda:0', dtype=torch.float16)
    ...
    arg16_1 = rand_strided((640, 1280, 1, 1), (1280, 1, 1, 1), device='cuda:0', dtype=torch.float16)
    arg17_1 = rand_strided((640, ), (1, ), device='cuda:0', dtype=torch.float16)
    arg18_1 = rand_strided((64, 1280, 1, 1), (1280, 1, 1, 1), device='cuda:0', dtype=torch.float16)
    arg19_1 = rand_strided((640, 64, 1, 1), (64, 1, 1, 1), device='cuda:0', dtype=torch.float16)
    arg20_1 = 15
    arg21_1 = 45
    arg22_1 = rand_strided((22, 1280, 15, 45), (864000, 675, 45, 1), device='cuda:0', dtype=torch.float16)
