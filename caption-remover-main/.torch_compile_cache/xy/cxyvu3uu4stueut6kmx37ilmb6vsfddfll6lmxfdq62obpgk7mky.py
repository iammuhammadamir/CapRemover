...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/iv/civguccbttsv5bzru7hq3vyhpmpdaujjr7b6ge4imdorfutkrxin.py
...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/fm/cfmw6ulyoep5w4yt5f4jplo36pcby3ue56fi2ige3blqwr23vhnf.py
...
def call(args):
    ...
    assert_size_stride(arg2_1, (320, 640, 3, 3), (5760, 9, 3, 1))
    ...
    assert_size_stride(arg16_1, (320, 640, 1, 1), (640, 1, 1, 1))
    assert_size_stride(arg17_1, (320, ), (1, ))
    assert_size_stride(arg18_1, (64, 640, 1, 1), (640, 1, 1, 1))
    assert_size_stride(arg19_1, (320, 64, 1, 1), (64, 1, 1, 1))
    assert_size_stride(arg22_1, (22, 640, s1, s2), (640*s1*s2, s1*s2, s2, 1))
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg2_1 = rand_strided((320, 640, 3, 3), (5760, 9, 3, 1), device='cuda:0', dtype=torch.float16)
    ...
    arg16_1 = rand_strided((320, 640, 1, 1), (640, 1, 1, 1), device='cuda:0', dtype=torch.float16)
    arg17_1 = rand_strided((320, ), (1, ), device='cuda:0', dtype=torch.float16)
    arg18_1 = rand_strided((64, 640, 1, 1), (640, 1, 1, 1), device='cuda:0', dtype=torch.float16)
    arg19_1 = rand_strided((320, 64, 1, 1), (64, 1, 1, 1), device='cuda:0', dtype=torch.float16)
    arg20_1 = 30
    arg21_1 = 90
    arg22_1 = rand_strided((22, 640, 30, 90), (1728000, 2700, 90, 1), device='cuda:0', dtype=torch.float16)
