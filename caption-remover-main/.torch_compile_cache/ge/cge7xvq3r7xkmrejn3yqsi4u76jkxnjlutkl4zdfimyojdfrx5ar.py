...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/rs/crs5htylquz3jswpmmupu66jcdwpxhrd6nyslu5agwv47fs74yry.py
...
def triton_(in_ptr0, out_ptr0, out_ptr1, ks0, ks1, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        rmask = rindex < rnumel
        r1 = rindex
        tmp0 = tl.load(in_ptr0 + (r1 + (60*ks0*ks1*x0)), rmask & xmask, eviction_policy='evict_first', other=0.0).to(tl.float32)
...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/a4/ca4ogiwj74e7yitnvo3qultrtdfvlryrlflbyhdshohcnoplfaxi.py
...
def triton_(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr1, ks0, ks1, ks2, ks3, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp2 = tl.load(in_ptr1 + ((32*x2) + (x1 // 60)), xmask, eviction_policy='evict_last')
    tmp4 = tl.load(in_ptr2 + ((32*x2) + (x1 // 60)), xmask, eviction_policy='evict_last')
...
def call(args):
    ...
    s1 = arg20_1
    s2 = arg21_1
    assert_size_stride(arg0_1, (1920, ), (1, ))
    assert_size_stride(arg1_1, (1920, ), (1, ))
    assert_size_stride(arg2_1, (640, 1920, 3, 3), (17280, 9, 3, 1))
    assert_size_stride(arg3_1, (640, ), (1, ))
    assert_size_stride(arg4_1, (64, 1920, 3, 3), (17280, 9, 3, 1))
    ...
    assert_size_stride(arg16_1, (640, 1920, 1, 1), (1920, 1, 1, 1))
    assert_size_stride(arg17_1, (640, ), (1, ))
    assert_size_stride(arg18_1, (64, 1920, 1, 1), (1920, 1, 1, 1))
    assert_size_stride(arg19_1, (640, 64, 1, 1), (64, 1, 1, 1))
    assert_size_stride(arg22_1, (22, 1920, s1, s2), (1920*s1*s2, s1*s2, s2, 1))
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        # Source Nodes: [hidden_states_1], Original ATen: [aten.native_group_norm]
        triton_red_fused_native_group_norm_0_rnumel = 60*s1*s2
        ...
        ps0 = s1*s2
        ps1 = 1920*s1*s2
        buf4 = empty_strided_cuda((22, 1920, s1, s2), (1920*s1*s2, s1*s2, s2, 1), torch.float16)
        # Source Nodes: [hidden_states_1, hidden_states_2], Original ATen: [aten.native_group_norm, aten.silu]
        triton_poi_fused_native_group_norm_silu_1_xnumel = 42240*s1*s2
        ...
        assert_size_stride(buf16, (22, 640, s1, s2), (640*s1*s2, s1*s2, s2, 1))
        del arg16_1
        ...
        # Source Nodes: [hidden_states_5, hidden_states_6], Original ATen: [aten.native_group_norm, aten.silu]
        triton_poi_fused_native_group_norm_silu_4_xnumel = 14080*s1*s2
        ...
        assert_size_stride(buf21, (22, 640, s1, s2), (640*s1*s2, s1*s2, s2, 1))
        del arg12_1
        ...
        assert_size_stride(buf23, (22, 640, s1, s2), (640*s1*s2, s1*s2, s2, 1))
        del arg15_1
        del buf22
        buf24 = buf16; del buf16  # reuse
        # Source Nodes: [add_5, mul_2, mul_3, output_tensor, result_10, result_6, result_7, result_9], Original ATen: [aten.add, aten.convolution, aten.div, aten.mul]
        triton_poi_fused_add_convolution_div_mul_5_xnumel = 14080*s1*s2
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg0_1 = rand_strided((1920, ), (1, ), device='cuda:0', dtype=torch.float16)
    arg1_1 = rand_strided((1920, ), (1, ), device='cuda:0', dtype=torch.float16)
    arg2_1 = rand_strided((640, 1920, 3, 3), (17280, 9, 3, 1), device='cuda:0', dtype=torch.float16)
    arg3_1 = rand_strided((640, ), (1, ), device='cuda:0', dtype=torch.float16)
    arg4_1 = rand_strided((64, 1920, 3, 3), (17280, 9, 3, 1), device='cuda:0', dtype=torch.float16)
    ...
    arg16_1 = rand_strided((640, 1920, 1, 1), (1920, 1, 1, 1), device='cuda:0', dtype=torch.float16)
    arg17_1 = rand_strided((640, ), (1, ), device='cuda:0', dtype=torch.float16)
    arg18_1 = rand_strided((64, 1920, 1, 1), (1920, 1, 1, 1), device='cuda:0', dtype=torch.float16)
    arg19_1 = rand_strided((640, 64, 1, 1), (64, 1, 1, 1), device='cuda:0', dtype=torch.float16)
    arg20_1 = 15
    arg21_1 = 45
    arg22_1 = rand_strided((22, 1920, 15, 45), (1296000, 675, 45, 1), device='cuda:0', dtype=torch.float16)
