...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/i4/ci4m2gkgv2pmx27b6zny5dwn5lr3hywsrw44mdsbmuthvpcxp2y7.py
...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/zw/czwjoqlowq3xpmsdipqft5zpbwouokt2croembisfkj4gswyo2oe.py
...
def triton_(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr1, ks0, ks1, ks2, ks3, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp2 = tl.load(in_ptr1 + ((32*x2) + (x1 // 30)), xmask, eviction_policy='evict_last')
    tmp4 = tl.load(in_ptr2 + ((32*x2) + (x1 // 30)), xmask, eviction_policy='evict_last')
...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/it/citx6by2jpdfwtl5ita376p7ckzqgbzwhtymzclpynsrxi6jx46r.py
...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/ki/ckidiote2wonmmvsdiq4zjnpyjbwybopz5zel3rw5izj4yrkfajo.py
...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/fd/cfdwhvp54buwdscsgvd6dtyel2ojzi734ahnuedppzg33nmgkowi.py
...
def call(args):
    ...
    assert_size_stride(arg2_1, (320, 960, 3, 3), (8640, 9, 3, 1))
    assert_size_stride(arg3_1, (320, ), (1, ))
    assert_size_stride(arg4_1, (64, 960, 3, 3), (8640, 9, 3, 1))
    ...
    assert_size_stride(arg16_1, (320, 960, 1, 1), (960, 1, 1, 1))
    assert_size_stride(arg17_1, (320, ), (1, ))
    assert_size_stride(arg18_1, (64, 960, 1, 1), (960, 1, 1, 1))
    assert_size_stride(arg19_1, (320, 64, 1, 1), (64, 1, 1, 1))
    assert_size_stride(arg22_1, (22, 960, s1, s2), (960*s1*s2, s1*s2, s2, 1))
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        # Source Nodes: [hidden_states_1], Original ATen: [aten.native_group_norm]
        triton_red_fused_native_group_norm_0_rnumel = 30*s1*s2
        ...
        ps0 = s1*s2
        ps1 = 960*s1*s2
        buf4 = empty_strided_cuda((22, 960, s1, s2), (960*s1*s2, s1*s2, s2, 1), torch.float16)
        # Source Nodes: [hidden_states_1, hidden_states_2], Original ATen: [aten.native_group_norm, aten.silu]
        triton_poi_fused_native_group_norm_silu_1_xnumel = 21120*s1*s2
        ...
        assert_size_stride(buf5, (22, 320, s1, s2), (320*s1*s2, s1*s2, s2, 1))
        del arg2_1
        ...
        assert_size_stride(buf7, (22, 320, s1, s2), (320*s1*s2, s1*s2, s2, 1))
        del arg5_1
        del buf6
        ...
        del arg23_1
        buf9 = empty_strided_cuda((22, 320), (320, 1), torch.float16)
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(buf8, reinterpret_tensor(arg6_1, (1280, 320), (1, 1280), 0), out=buf9)
        del arg6_1
        ...
        extern_kernels.mm(buf10, reinterpret_tensor(arg9_1, (64, 320), (1, 64), 0), out=buf11)
        del arg9_1
        del buf10
        ...
        # Source Nodes: [hidden_states_4, hidden_states_5, mul, result, result_1], Original ATen: [aten.add, aten.convolution, aten.mul, aten.native_group_norm]
        triton_red_fused_add_convolution_mul_native_group_norm_3_rnumel = 10*s1*s2
        ...
        assert_size_stride(buf16, (22, 320, s1, s2), (320*s1*s2, s1*s2, s2, 1))
        del arg16_1
        ...
        assert_size_stride(buf18, (22, 320, s1, s2), (320*s1*s2, s1*s2, s2, 1))
        del arg19_1
        del buf17
        ps2 = 320*s1*s2
        buf20 = buf7; del buf7  # reuse
        # Source Nodes: [hidden_states_5, hidden_states_6], Original ATen: [aten.native_group_norm, aten.silu]
        triton_poi_fused_native_group_norm_silu_4_xnumel = 7040*s1*s2
        ...
        assert_size_stride(buf21, (22, 320, s1, s2), (320*s1*s2, s1*s2, s2, 1))
        del arg12_1
        ...
        assert_size_stride(buf23, (22, 320, s1, s2), (320*s1*s2, s1*s2, s2, 1))
        del arg15_1
        del buf22
        buf24 = buf16; del buf16  # reuse
        # Source Nodes: [add_5, mul_2, mul_3, output_tensor, result_10, result_6, result_7, result_9], Original ATen: [aten.add, aten.convolution, aten.div, aten.mul]
        triton_poi_fused_add_convolution_div_mul_5_xnumel = 7040*s1*s2
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg0_1 = rand_strided((960, ), (1, ), device='cuda:0', dtype=torch.float16)
    arg1_1 = rand_strided((960, ), (1, ), device='cuda:0', dtype=torch.float16)
    arg2_1 = rand_strided((320, 960, 3, 3), (8640, 9, 3, 1), device='cuda:0', dtype=torch.float16)
    arg3_1 = rand_strided((320, ), (1, ), device='cuda:0', dtype=torch.float16)
    arg4_1 = rand_strided((64, 960, 3, 3), (8640, 9, 3, 1), device='cuda:0', dtype=torch.float16)
    ...
    arg16_1 = rand_strided((320, 960, 1, 1), (960, 1, 1, 1), device='cuda:0', dtype=torch.float16)
    arg17_1 = rand_strided((320, ), (1, ), device='cuda:0', dtype=torch.float16)
    arg18_1 = rand_strided((64, 960, 1, 1), (960, 1, 1, 1), device='cuda:0', dtype=torch.float16)
    arg19_1 = rand_strided((320, 64, 1, 1), (64, 1, 1, 1), device='cuda:0', dtype=torch.float16)
    arg20_1 = 30
    arg21_1 = 90
    arg22_1 = rand_strided((22, 960, 30, 90), (2592000, 2700, 90, 1), device='cuda:0', dtype=torch.float16)
