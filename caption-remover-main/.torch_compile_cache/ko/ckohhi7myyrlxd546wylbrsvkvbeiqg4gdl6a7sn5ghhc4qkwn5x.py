...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/7v/c7v6ktwlcjpcy6fnaslba2h7gisf6burdtbdrgkftl7zbwpjxxre.py
...
def triton_(in_ptr0, out_ptr0, out_ptr1, out_ptr2, ks0, ks1, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        rmask = rindex < rnumel
        r1 = rindex
        tmp0 = tl.load(in_ptr0 + ((ks0*ks1*(r1 // (22*ks0*ks1))) + (2*ks0*ks1*x0) + (1280*ks0*ks1*((r1 % (22*ks0*ks1)) // (ks0*ks1))) + ((r1 % (22*ks0*ks1)) % (ks0*ks1))), rmask & xmask, eviction_policy='evict_last', other=0.0).to(tl.float32)
...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/yu/cyulatcju435c4mt4fqrcnddbaikk6e56onid6d5j4rqnat2pnlx.py
# Source Nodes: [hidden_states_2], Original ATen: [aten.native_group_norm]
# hidden_states_2 => convert_element_type, var_mean
...
def triton_(in_ptr0, in_ptr1, in_ptr2, out_ptr0, out_ptr1, xnumel, rnumel, XBLOCK : tl.constexpr):
    ...
    tmp1 = tl.load(in_ptr1 + (r1 + (20*x0)), rmask & xmask, other=0.0)
    tmp2 = tl.load(in_ptr2 + (r1 + (20*x0)), rmask & xmask, other=0.0)
...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/5z/c5zlwzbd253it5whmwzgls7otkyycsqlnrmd3luslozdw2hco2kt.py
# Source Nodes: [hidden_states_2], Original ATen: [aten.native_group_norm]
...
def triton_(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, ks0, ks1, ks2, ks3, xnumel, XBLOCK : tl.constexpr):
    ...
    x3 = (xindex // ks3)
    x5 = xindex
    tmp0 = tl.load(in_ptr0 + (x0 + (ks0*x1) + (ks0*ks1*x3) + (1280*ks0*ks1*x2) + (1280*ks0*ks1*((x0 + (ks0*x1)) // (ks0*ks1)))), xmask, eviction_policy='evict_last').to(tl.float32)
    tmp2 = tl.load(in_ptr1 + ((x3 // 40)), xmask, eviction_policy='evict_last')
    tmp4 = tl.load(in_ptr2 + ((x3 // 40)), xmask, eviction_policy='evict_last')
...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/6n/c6nttcmmfi2ywo3kefvc4lcrxeeradv4hly27c5quxdqf6jczfrt.py
...
triton_red_fused_add_native_layer_norm_3 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
@triton_heuristics.reduction(
    ...
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_red_fused_add_native_layer_norm_3', 'mutated_arg_names': [], 'no_x_dim': False, 'backend_hash': 'a1fa794fabf29fbd973066d9ab65d9c16aea0ed2e098514ffda941ec2a0f87ad'}
)
@triton.jit
def triton_(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        tmp26 = tl.load(in_ptr4 + (r1 + (1280*x2)), rmask & xmask, eviction_policy='evict_last', other=0.0).to(tl.float32)
        tmp10 = tmp8 + tmp9
...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/vh/cvhmy26a6f25pmlvkr57nl4ri4527cutlaec3agy24qa7mk5inrn.py
...
triton_red_fused_add_div_native_layer_norm_4 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/pr/cprpsxpr7hev3z2cpcrt63derb5pichysmuyp3qy4t7bm6en7w6r.py
...
triton_red_fused_add_div_native_layer_norm_5 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/bw/cbwrkfxvndirsbnmpu64dezv3jvp67glnfzh3oypk336sqt2eqjt.py
...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/qa/cqavarygxrjjsxhfk5mbppadol7ccqwma5oebhbmp5se7pwolhy6.py
...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/5l/c5lfiujh4m6mmrxkiywtbi2vmoy2hagcofoij37usmtrd6bv5cr4.py
...
def call(args):
    ...
    assert_size_stride(arg4_1, (1280, ), (1, ))
    assert_size_stride(arg5_1, (1280, ), (1, ))
    assert_size_stride(arg6_1, (1280, 1280), (1280, 1))
    assert_size_stride(arg7_1, (1280, 1280), (1280, 1))
    assert_size_stride(arg8_1, (1280, 1280), (1280, 1))
    assert_size_stride(arg9_1, (1280, 1280), (1280, 1))
    assert_size_stride(arg10_1, (1280, ), (1, ))
    assert_size_stride(arg11_1, (1280, ), (1, ))
    assert_size_stride(arg12_1, (1280, ), (1, ))
    assert_size_stride(arg13_1, (1280, 1280), (1280, 1))
    assert_size_stride(arg14_1, (1280, 1280), (1280, 1))
    assert_size_stride(arg15_1, (1280, 1280), (1280, 1))
    assert_size_stride(arg16_1, (1280, 1280), (1280, 1))
    assert_size_stride(arg17_1, (1280, ), (1, ))
    assert_size_stride(arg18_1, (1280, ), (1, ))
    assert_size_stride(arg19_1, (1280, ), (1, ))
    assert_size_stride(arg20_1, (10240, 1280), (1280, 1))
    assert_size_stride(arg21_1, (10240, ), (1, ))
    assert_size_stride(arg22_1, (1280, 5120), (5120, 1))
    assert_size_stride(arg23_1, (1280, ), (1, ))
    assert_size_stride(arg24_1, (1280, 1280), (1280, 1))
    assert_size_stride(arg25_1, (1280, ), (1, ))
    assert_size_stride(arg26_1, (1, 32, 1280), (40960, 1280, 1))
    assert_size_stride(arg29_1, (22, 1280, s1, s2), (1280*s1*s2, s1*s2, s2, 1))
    with torch.cuda._DeviceGuard(0):
        torch.cuda.set_device(0)
        buf0 = empty_strided_cuda((1, 32, 1, 1, 20), (640, 20, 640, 640, 1), torch.float32)
        buf1 = empty_strided_cuda((1, 32, 1, 1, 20), (640, 20, 640, 640, 1), torch.float32)
        buf2 = empty_strided_cuda((1, 32, 1, 1, 20), (640, 20, 640, 640, 1), torch.float32)
        # Source Nodes: [hidden_states_2], Original ATen: [aten.native_group_norm]
        triton_red_fused_native_group_norm_0_rnumel = 44*s1*s2
        stream0 = get_raw_stream(0)
        triton_red_fused_native_group_norm_0.run(arg29_1, buf0, buf1, buf2, s1, s2, 640, triton_red_fused_native_group_norm_0_rnumel, grid=grid(640), stream=stream0)
        buf3 = empty_strided_cuda((1, 32, 1, 1), (32, 1, 32, 32), torch.float32)
        buf4 = empty_strided_cuda((1, 32, 1, 1), (32, 1, 32, 32), torch.float32)
        # Source Nodes: [hidden_states_2], Original ATen: [aten.native_group_norm]
        triton_per_fused_native_group_norm_1.run(buf0, buf1, buf2, buf3, buf4, 32, 20, grid=grid(32), stream=stream0)
        del buf0
        del buf1
        del buf2
        ps0 = s1*s2
        ps1 = 22*s1*s2
        buf6 = empty_strided_cuda((1, 1280, 22, s1, s2), (28160*s1*s2, 22*s1*s2, s1*s2, s2, 1), torch.float16)
        # Source Nodes: [hidden_states_2], Original ATen: [aten.native_group_norm]
        triton_poi_fused_native_group_norm_2_xnumel = 28160*s1*s2
        ...
        del buf3
        del buf4
        buf7 = empty_strided_cuda((s1*s2, 22, 1280), (28160, 1280, 1), torch.float16)
        # Source Nodes: [hidden_states_4], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf6, (s1*s2, 22, 1280), (1, s1*s2, 22*s1*s2), 0), reinterpret_tensor(arg2_1, (s1*s2, 1280, 1280), (0, 1, 1280), 0), out=buf7)
        del arg2_1
        buf11 = reinterpret_tensor(buf6, (s1*s2, 22, 1280), (28160, 1280, 1), 0); del buf6  # reuse
        # Source Nodes: [encoder_hidden_states, hidden_states_4, norm_hidden_states], Original ATen: [aten.add, aten.native_layer_norm]
        triton_red_fused_add_native_layer_norm_3_xnumel = 22*s1*s2
        triton_red_fused_add_native_layer_norm_3.run(buf7, arg3_1, arg4_1, arg5_1, arg26_1, buf11, triton_red_fused_add_native_layer_norm_3_xnumel, 1280, grid=grid(triton_red_fused_add_native_layer_norm_3_xnumel), stream=stream0)
        del arg4_1
        del arg5_1
        buf12 = empty_strided_cuda((22*s1*s2, 1280), (1280, 1), torch.float16)
        # Source Nodes: [query], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf11, (22*s1*s2, 1280), (1280, 1), 0), reinterpret_tensor(arg6_1, (1280, 1280), (1, 1280), 0), out=buf12)
        del arg6_1
        buf13 = empty_strided_cuda((22*s1*s2, 1280), (1280, 1), torch.float16)
        # Source Nodes: [key], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf11, (22*s1*s2, 1280), (1280, 1), 0), reinterpret_tensor(arg7_1, (1280, 1280), (1, 1280), 0), out=buf13)
        del arg7_1
        buf14 = empty_strided_cuda((22*s1*s2, 1280), (1280, 1), torch.float16)
        # Source Nodes: [value], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf11, (22*s1*s2, 1280), (1280, 1), 0), reinterpret_tensor(arg8_1, (1280, 1280), (1, 1280), 0), out=buf14)
        del arg8_1
        # Source Nodes: [hidden_states_5], Original ATen: [aten._scaled_dot_product_flash_attention]
        buf15 = aten._scaled_dot_product_flash_attention.default(reinterpret_tensor(buf12, (s1*s2, 8, 22, 160), (28160, 160, 1280, 1), 0), reinterpret_tensor(buf13, (s1*s2, 8, 22, 160), (28160, 160, 1280, 1), 0), reinterpret_tensor(buf14, (s1*s2, 8, 22, 160), (28160, 160, 1280, 1), 0), scale=0.07905694150420949)
        buf16 = buf15[0]
        del buf15
        buf21 = buf14; del buf14  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf16, (22*s1*s2, 1280), (1280, 1), 0), reinterpret_tensor(arg9_1, (1280, 1280), (1, 1280), 0), out=buf21)
        del arg9_1
        buf25 = reinterpret_tensor(buf16, (s1*s2, 22, 1280), (28160, 1280, 1), 0); del buf16  # reuse
        # Source Nodes: [attn_output, encoder_hidden_states_1, hidden_states_11, hidden_states_4, norm_hidden_states_2], Original ATen: [aten.add, aten.div, aten.native_layer_norm]
        triton_red_fused_add_div_native_layer_norm_4_xnumel = 22*s1*s2
        triton_red_fused_add_div_native_layer_norm_4.run(buf21, arg10_1, buf7, arg3_1, arg11_1, arg12_1, arg26_1, buf25, triton_red_fused_add_div_native_layer_norm_4_xnumel, 1280, grid=grid(triton_red_fused_add_div_native_layer_norm_4_xnumel), stream=stream0)
        del arg11_1
        del arg12_1
        del arg26_1
        buf26 = buf13; del buf13  # reuse
        # Source Nodes: [query_2], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf25, (22*s1*s2, 1280), (1280, 1), 0), reinterpret_tensor(arg13_1, (1280, 1280), (1, 1280), 0), out=buf26)
        del arg13_1
        buf27 = buf12; del buf12  # reuse
        # Source Nodes: [key_2], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf25, (22*s1*s2, 1280), (1280, 1), 0), reinterpret_tensor(arg14_1, (1280, 1280), (1, 1280), 0), out=buf27)
        del arg14_1
        buf28 = reinterpret_tensor(buf11, (22*s1*s2, 1280), (1280, 1), 0); del buf11  # reuse
        # Source Nodes: [value_2], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf25, (22*s1*s2, 1280), (1280, 1), 0), reinterpret_tensor(arg15_1, (1280, 1280), (1, 1280), 0), out=buf28)
        del arg15_1
        del buf25
        # Source Nodes: [hidden_states_12], Original ATen: [aten._scaled_dot_product_flash_attention]
        buf29 = aten._scaled_dot_product_flash_attention.default(reinterpret_tensor(buf26, (s1*s2, 8, 22, 160), (28160, 160, 1280, 1), 0), reinterpret_tensor(buf27, (s1*s2, 8, 22, 160), (28160, 160, 1280, 1), 0), reinterpret_tensor(buf28, (s1*s2, 8, 22, 160), (28160, 160, 1280, 1), 0), scale=0.07905694150420949)
        del buf26
        del buf27
        buf30 = buf29[0]
        del buf29
        ...
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf30, (22*s1*s2, 1280), (1280, 1), 0), reinterpret_tensor(arg16_1, (1280, 1280), (1, 1280), 0), out=buf35)
        del arg16_1
        buf36 = reinterpret_tensor(buf35, (s1*s2, 22, 1280), (28160, 1280, 1), 0); del buf35  # reuse
        buf40 = reinterpret_tensor(buf30, (s1*s2, 22, 1280), (28160, 1280, 1), 0); del buf30  # reuse
        # Source Nodes: [attn_output, attn_output_1, hidden_states_11, hidden_states_18, hidden_states_4, norm_hidden_states_4], Original ATen: [aten.add, aten.div, aten.native_layer_norm]
        triton_red_fused_add_div_native_layer_norm_5_xnumel = 22*s1*s2
        triton_red_fused_add_div_native_layer_norm_5.run(buf36, arg17_1, buf21, arg10_1, buf7, arg3_1, arg18_1, arg19_1, buf40, triton_red_fused_add_div_native_layer_norm_5_xnumel, 1280, grid=grid(triton_red_fused_add_div_native_layer_norm_5_xnumel), stream=stream0)
        del arg10_1
        del arg17_1
        del arg18_1
        del arg19_1
        ...
        del buf21
        del buf7
        buf41 = empty_strided_cuda((22*s1*s2, 10240), (10240, 1), torch.float16)
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf40, (22*s1*s2, 1280), (1280, 1), 0), reinterpret_tensor(arg20_1, (1280, 10240), (1, 1280), 0), out=buf41)
        del arg20_1
        buf42 = empty_strided_cuda((s1*s2, 22, 5120), (112640, 5120, 1), torch.float16)
        # Source Nodes: [gelu, hidden_states_21], Original ATen: [aten.gelu, aten.mul]
        triton_poi_fused_gelu_mul_6_xnumel = 112640*s1*s2
        ...
        del arg21_1
        del buf41
        buf43 = reinterpret_tensor(buf40, (22*s1*s2, 1280), (1280, 1), 0); del buf40  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf42, (22*s1*s2, 5120), (5120, 1), 0), reinterpret_tensor(arg22_1, (5120, 1280), (1, 5120), 0), out=buf43)
        del arg22_1
        del buf42
        buf44 = reinterpret_tensor(buf43, (s1*s2, 22, 1280), (28160, 1280, 1), 0); del buf43  # reuse
        # Source Nodes: [hidden_states_25], Original ATen: [aten.add]
        triton_poi_fused_add_7_xnumel = 28160*s1*s2
        ...
        del arg23_1
        buf45 = reinterpret_tensor(buf36, (22*s1*s2, 1280), (1280, 1), 0); del buf36  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf44, (22*s1*s2, 1280), (1280, 1), 0), reinterpret_tensor(arg24_1, (1280, 1280), (1, 1280), 0), out=buf45)
        del arg24_1
        buf46 = reinterpret_tensor(buf44, (22, 1280, s1, s2), (1280*s1*s2, s1*s2, s2, 1), 0); del buf44  # reuse
        # Source Nodes: [output], Original ATen: [aten.add]
        triton_poi_fused_add_8_xnumel = s1*s2
        triton_poi_fused_add_8.run(buf45, arg25_1, arg29_1, buf46, s1, s2, 28160, triton_poi_fused_add_8_xnumel, grid=grid(28160, triton_poi_fused_add_8_xnumel), stream=stream0)
        del arg25_1
        del arg29_1
        del buf45
    return (buf46, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg4_1 = rand_strided((1280, ), (1, ), device='cuda:0', dtype=torch.float16)
    arg5_1 = rand_strided((1280, ), (1, ), device='cuda:0', dtype=torch.float16)
    arg6_1 = rand_strided((1280, 1280), (1280, 1), device='cuda:0', dtype=torch.float16)
    arg7_1 = rand_strided((1280, 1280), (1280, 1), device='cuda:0', dtype=torch.float16)
    arg8_1 = rand_strided((1280, 1280), (1280, 1), device='cuda:0', dtype=torch.float16)
    arg9_1 = rand_strided((1280, 1280), (1280, 1), device='cuda:0', dtype=torch.float16)
    ...
    arg12_1 = rand_strided((1280, ), (1, ), device='cuda:0', dtype=torch.float16)
    arg13_1 = rand_strided((1280, 1280), (1280, 1), device='cuda:0', dtype=torch.float16)
    arg14_1 = rand_strided((1280, 1280), (1280, 1), device='cuda:0', dtype=torch.float16)
    arg15_1 = rand_strided((1280, 1280), (1280, 1), device='cuda:0', dtype=torch.float16)
    arg16_1 = rand_strided((1280, 1280), (1280, 1), device='cuda:0', dtype=torch.float16)
    ...
    arg19_1 = rand_strided((1280, ), (1, ), device='cuda:0', dtype=torch.float16)
    arg20_1 = rand_strided((10240, 1280), (1280, 1), device='cuda:0', dtype=torch.float16)
    arg21_1 = rand_strided((10240, ), (1, ), device='cuda:0', dtype=torch.float16)
    arg22_1 = rand_strided((1280, 5120), (5120, 1), device='cuda:0', dtype=torch.float16)
    arg23_1 = rand_strided((1280, ), (1, ), device='cuda:0', dtype=torch.float16)
    arg24_1 = rand_strided((1280, 1280), (1280, 1), device='cuda:0', dtype=torch.float16)
    arg25_1 = rand_strided((1280, ), (1, ), device='cuda:0', dtype=torch.float16)
    arg26_1 = rand_strided((1, 32, 1280), (40960, 1280, 1), device='cuda:0', dtype=torch.float16)
    arg27_1 = 8
    arg28_1 = 23
    arg29_1 = rand_strided((22, 1280, 8, 23), (235520, 184, 23, 1), device='cuda:0', dtype=torch.float16)
