...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/a6/ca64uwwb72kxqek26ydlqerlqr562hwkz7a5l33g5lzv7ca6tcx7.py
...
def triton_(in_ptr0, out_ptr0, out_ptr1, out_ptr2, ks0, ks1, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        rmask = rindex < rnumel
        r2 = rindex
        tmp0 = r2 + (x1*((17 + (440*ks0*ks1)) // 18))
        tmp1 = 440*ks0*ks1
        tmp2 = tmp0 < tmp1
        tmp3 = tl.load(in_ptr0 + ((ks0*ks1*(((r2 + (x1*((17 + (440*ks0*ks1)) // 18))) // (22*ks0*ks1)) % 20)) + (20*ks0*ks1*x0) + (640*ks0*ks1*(((r2 + (x1*((17 + (440*ks0*ks1)) // 18))) % (22*ks0*ks1)) // (ks0*ks1))) + (((r2 + (x1*((17 + (440*ks0*ks1)) // 18))) % (22*ks0*ks1)) % (ks0*ks1))), rmask & tmp2 & xmask, eviction_policy='evict_last', other=0.0).to(tl.float32)
...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/ak/cakezwzecckdd2xyt3hjuwvshn25436jeoez5dregd4rwhzb4j2s.py
# Source Nodes: [hidden_states_2], Original ATen: [aten.native_group_norm]
...
def triton_(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, ks0, ks1, ks2, ks3, xnumel, XBLOCK : tl.constexpr):
    ...
    x3 = (xindex // ks3)
    x5 = xindex
    tmp0 = tl.load(in_ptr0 + (x0 + (ks0*x1) + (ks0*ks1*x3) + (640*ks0*ks1*x2) + (640*ks0*ks1*((x0 + (ks0*x1)) // (ks0*ks1)))), xmask, eviction_policy='evict_last').to(tl.float32)
    tmp2 = tl.load(in_ptr1 + ((x3 // 20)), xmask, eviction_policy='evict_last')
    tmp4 = tl.load(in_ptr2 + ((x3 // 20)), xmask, eviction_policy='evict_last')
...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/ys/cysv65g6fehwwpnles7bgkp5wodj65n6ynuv7mziwvlwhxkeoqyo.py
...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/3s/c3stchpxlwgvyradkxzw3jd4wieyquy4if4lwijlsrscrannlw6a.py
...
def triton_(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, in_ptr6, out_ptr2, xnumel, rnumel):
    ...
    tmp0 = tl.load(in_ptr0 + (r1 + (640*x0)), rmask & xmask, other=0.0).to(tl.float32)
    tmp1 = tl.load(in_ptr1 + (r1), rmask, eviction_policy='evict_last', other=0.0).to(tl.float32)
    tmp5 = tl.load(in_ptr2 + (r1 + (640*x0)), rmask & xmask, other=0.0).to(tl.float32)
    ...
    tmp40 = tl.load(in_ptr6 + (r1 + (640*x2)), rmask & xmask, eviction_policy='evict_last', other=0.0).to(tl.float32)
    tmp2 = tmp0 + tmp1
    tmp3 = 1.0
    tmp4 = tmp2 / tmp3
    tmp7 = tmp5 + tmp6
...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/fk/cfkyswos4lqvn3gn2vtxyn5ewfq4zwv2pvluycfg5weitenffzpc.py
...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/7b/c7bdo5ofjtuvi6swnyhgmapmqwfqljswwf5cmockqah2wia2fs4o.py
...
def triton_(in_ptr0, in_ptr1, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp3 = tl.load(in_ptr0 + (2560 + x0 + (5120*x1)), xmask).to(tl.float32)
    tmp4 = tl.load(in_ptr1 + (2560 + x0), xmask, eviction_policy='evict_last').to(tl.float32)
    tmp2 = tmp0 + tmp1
    tmp5 = tmp3 + tmp4
    tmp6 = tmp5.to(tl.float32)
    tmp7 = 0.5
...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/z4/cz4ut5dpw33fzyiskj74q5y7sovq6n7udu2g2a775depjuv77sir.py
...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/cb/ccbzo6emgken5gonniacp77wxptgxousgbm5wb4fvxtfppggfsrq.py
...
def triton_(in_ptr0, in_ptr1, in_ptr2, out_ptr0, ks0, ks1, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    y3 = yindex
    y0 = yindex % 640
    tmp0 = tl.load(in_ptr0 + (y3 + (14080*x2)), xmask & ymask, eviction_policy='evict_last').to(tl.float32)
...
def call(args):
    ...
    assert_size_stride(arg2_1, (640, 640), (640, 1))
    assert_size_stride(arg3_1, (640, ), (1, ))
    assert_size_stride(arg4_1, (640, ), (1, ))
    assert_size_stride(arg5_1, (640, ), (1, ))
    ...
    assert_size_stride(arg12_1, (640, ), (1, ))
    assert_size_stride(arg13_1, (640, 640), (640, 1))
    assert_size_stride(arg14_1, (640, 640), (640, 1))
    assert_size_stride(arg15_1, (640, 640), (640, 1))
    assert_size_stride(arg16_1, (640, 640), (640, 1))
    assert_size_stride(arg17_1, (640, ), (1, ))
    assert_size_stride(arg18_1, (640, ), (1, ))
    assert_size_stride(arg19_1, (640, ), (1, ))
    assert_size_stride(arg20_1, (5120, 640), (640, 1))
    assert_size_stride(arg21_1, (5120, ), (1, ))
    assert_size_stride(arg22_1, (640, 2560), (2560, 1))
    assert_size_stride(arg23_1, (640, ), (1, ))
    assert_size_stride(arg24_1, (640, 640), (640, 1))
    assert_size_stride(arg25_1, (640, ), (1, ))
    assert_size_stride(arg26_1, (1, 32, 640), (20480, 640, 1))
    assert_size_stride(arg29_1, (22, 640, s1, s2), (640*s1*s2, s1*s2, s2, 1))
    with torch.cuda._DeviceGuard(0):
        ...
        # Source Nodes: [hidden_states_2], Original ATen: [aten.native_group_norm]
        triton_red_fused_native_group_norm_0_rnumel = ((17 + (440*s1*s2)) // 18)
        ...
        ps0 = s1*s2
        ps1 = 22*s1*s2
        buf6 = empty_strided_cuda((1, 640, 22, s1, s2), (14080*s1*s2, 22*s1*s2, s1*s2, s2, 1), torch.float16)
        # Source Nodes: [hidden_states_2], Original ATen: [aten.native_group_norm]
        triton_poi_fused_native_group_norm_2_xnumel = 14080*s1*s2
        ...
        del buf3
        del buf4
        buf7 = empty_strided_cuda((s1*s2, 22, 640), (14080, 640, 1), torch.float16)
        # Source Nodes: [hidden_states_4], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf6, (s1*s2, 22, 640), (1, s1*s2, 22*s1*s2), 0), reinterpret_tensor(arg2_1, (s1*s2, 640, 640), (0, 1, 640), 0), out=buf7)
        del arg2_1
        buf11 = reinterpret_tensor(buf6, (s1*s2, 22, 640), (14080, 640, 1), 0); del buf6  # reuse
        # Source Nodes: [encoder_hidden_states, hidden_states_4, norm_hidden_states], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_3_xnumel = 22*s1*s2
        triton_per_fused_add_native_layer_norm_3.run(buf7, arg3_1, arg4_1, arg5_1, arg26_1, buf11, triton_per_fused_add_native_layer_norm_3_xnumel, 640, grid=grid(triton_per_fused_add_native_layer_norm_3_xnumel), stream=stream0)
        del arg4_1
        del arg5_1
        buf12 = empty_strided_cuda((22*s1*s2, 640), (640, 1), torch.float16)
        # Source Nodes: [query], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf11, (22*s1*s2, 640), (640, 1), 0), reinterpret_tensor(arg6_1, (640, 640), (1, 640), 0), out=buf12)
        del arg6_1
        buf13 = empty_strided_cuda((22*s1*s2, 640), (640, 1), torch.float16)
        # Source Nodes: [key], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf11, (22*s1*s2, 640), (640, 1), 0), reinterpret_tensor(arg7_1, (640, 640), (1, 640), 0), out=buf13)
        del arg7_1
        buf14 = empty_strided_cuda((22*s1*s2, 640), (640, 1), torch.float16)
        # Source Nodes: [value], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf11, (22*s1*s2, 640), (640, 1), 0), reinterpret_tensor(arg8_1, (640, 640), (1, 640), 0), out=buf14)
        del arg8_1
        # Source Nodes: [hidden_states_5], Original ATen: [aten._scaled_dot_product_flash_attention]
        buf15 = aten._scaled_dot_product_flash_attention.default(reinterpret_tensor(buf12, (s1*s2, 8, 22, 80), (14080, 80, 640, 1), 0), reinterpret_tensor(buf13, (s1*s2, 8, 22, 80), (14080, 80, 640, 1), 0), reinterpret_tensor(buf14, (s1*s2, 8, 22, 80), (14080, 80, 640, 1), 0), scale=0.11180339887498948)
        buf16 = buf15[0]
        del buf15
        buf21 = buf14; del buf14  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf16, (22*s1*s2, 640), (640, 1), 0), reinterpret_tensor(arg9_1, (640, 640), (1, 640), 0), out=buf21)
        del arg9_1
        buf25 = reinterpret_tensor(buf16, (s1*s2, 22, 640), (14080, 640, 1), 0); del buf16  # reuse
        # Source Nodes: [attn_output, encoder_hidden_states_1, hidden_states_11, hidden_states_4, norm_hidden_states_2], Original ATen: [aten.add, aten.div, aten.native_layer_norm]
        triton_per_fused_add_div_native_layer_norm_4_xnumel = 22*s1*s2
        triton_per_fused_add_div_native_layer_norm_4.run(buf21, arg10_1, buf7, arg3_1, arg11_1, arg12_1, arg26_1, buf25, triton_per_fused_add_div_native_layer_norm_4_xnumel, 640, grid=grid(triton_per_fused_add_div_native_layer_norm_4_xnumel), stream=stream0)
        del arg11_1
        del arg12_1
        del arg26_1
        buf26 = buf13; del buf13  # reuse
        # Source Nodes: [query_2], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf25, (22*s1*s2, 640), (640, 1), 0), reinterpret_tensor(arg13_1, (640, 640), (1, 640), 0), out=buf26)
        del arg13_1
        buf27 = buf12; del buf12  # reuse
        # Source Nodes: [key_2], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf25, (22*s1*s2, 640), (640, 1), 0), reinterpret_tensor(arg14_1, (640, 640), (1, 640), 0), out=buf27)
        del arg14_1
        buf28 = reinterpret_tensor(buf11, (22*s1*s2, 640), (640, 1), 0); del buf11  # reuse
        # Source Nodes: [value_2], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf25, (22*s1*s2, 640), (640, 1), 0), reinterpret_tensor(arg15_1, (640, 640), (1, 640), 0), out=buf28)
        del arg15_1
        del buf25
        # Source Nodes: [hidden_states_12], Original ATen: [aten._scaled_dot_product_flash_attention]
        buf29 = aten._scaled_dot_product_flash_attention.default(reinterpret_tensor(buf26, (s1*s2, 8, 22, 80), (14080, 80, 640, 1), 0), reinterpret_tensor(buf27, (s1*s2, 8, 22, 80), (14080, 80, 640, 1), 0), reinterpret_tensor(buf28, (s1*s2, 8, 22, 80), (14080, 80, 640, 1), 0), scale=0.11180339887498948)
        del buf26
        del buf27
        buf30 = buf29[0]
        del buf29
        ...
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf30, (22*s1*s2, 640), (640, 1), 0), reinterpret_tensor(arg16_1, (640, 640), (1, 640), 0), out=buf35)
        del arg16_1
        buf36 = reinterpret_tensor(buf35, (s1*s2, 22, 640), (14080, 640, 1), 0); del buf35  # reuse
        buf40 = reinterpret_tensor(buf30, (s1*s2, 22, 640), (14080, 640, 1), 0); del buf30  # reuse
        # Source Nodes: [attn_output, attn_output_1, hidden_states_11, hidden_states_18, hidden_states_4, norm_hidden_states_4], Original ATen: [aten.add, aten.div, aten.native_layer_norm]
        triton_per_fused_add_div_native_layer_norm_5_xnumel = 22*s1*s2
        triton_per_fused_add_div_native_layer_norm_5.run(buf36, arg17_1, buf21, arg10_1, buf7, arg3_1, arg18_1, arg19_1, buf40, triton_per_fused_add_div_native_layer_norm_5_xnumel, 640, grid=grid(triton_per_fused_add_div_native_layer_norm_5_xnumel), stream=stream0)
        del arg10_1
        del arg17_1
        del arg18_1
        del arg19_1
        ...
        del buf21
        del buf7
        buf41 = empty_strided_cuda((22*s1*s2, 5120), (5120, 1), torch.float16)
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf40, (22*s1*s2, 640), (640, 1), 0), reinterpret_tensor(arg20_1, (640, 5120), (1, 640), 0), out=buf41)
        del arg20_1
        buf42 = empty_strided_cuda((s1*s2, 22, 2560), (56320, 2560, 1), torch.float16)
        # Source Nodes: [gelu, hidden_states_21], Original ATen: [aten.gelu, aten.mul]
        triton_poi_fused_gelu_mul_6_xnumel = 56320*s1*s2
        ...
        del arg21_1
        del buf41
        buf43 = reinterpret_tensor(buf40, (22*s1*s2, 640), (640, 1), 0); del buf40  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf42, (22*s1*s2, 2560), (2560, 1), 0), reinterpret_tensor(arg22_1, (2560, 640), (1, 2560), 0), out=buf43)
        del arg22_1
        del buf42
        buf44 = reinterpret_tensor(buf43, (s1*s2, 22, 640), (14080, 640, 1), 0); del buf43  # reuse
        # Source Nodes: [hidden_states_25], Original ATen: [aten.add]
        triton_poi_fused_add_7_xnumel = 14080*s1*s2
        ...
        del arg23_1
        buf45 = reinterpret_tensor(buf36, (22*s1*s2, 640), (640, 1), 0); del buf36  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf44, (22*s1*s2, 640), (640, 1), 0), reinterpret_tensor(arg24_1, (640, 640), (1, 640), 0), out=buf45)
        del arg24_1
        buf46 = reinterpret_tensor(buf44, (22, 640, s1, s2), (640*s1*s2, s1*s2, s2, 1), 0); del buf44  # reuse
        # Source Nodes: [output], Original ATen: [aten.add]
        triton_poi_fused_add_8_xnumel = s1*s2
        triton_poi_fused_add_8.run(buf45, arg25_1, arg29_1, buf46, s1, s2, 14080, triton_poi_fused_add_8_xnumel, grid=grid(14080, triton_poi_fused_add_8_xnumel), stream=stream0)
        del arg25_1
        del arg29_1
        del buf45
    return (buf46, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg2_1 = rand_strided((640, 640), (640, 1), device='cuda:0', dtype=torch.float16)
    arg3_1 = rand_strided((640, ), (1, ), device='cuda:0', dtype=torch.float16)
    arg4_1 = rand_strided((640, ), (1, ), device='cuda:0', dtype=torch.float16)
    arg5_1 = rand_strided((640, ), (1, ), device='cuda:0', dtype=torch.float16)
    arg6_1 = rand_strided((640, 640), (640, 1), device='cuda:0', dtype=torch.float16)
    arg7_1 = rand_strided((640, 640), (640, 1), device='cuda:0', dtype=torch.float16)
    arg8_1 = rand_strided((640, 640), (640, 1), device='cuda:0', dtype=torch.float16)
    arg9_1 = rand_strided((640, 640), (640, 1), device='cuda:0', dtype=torch.float16)
    arg10_1 = rand_strided((640, ), (1, ), device='cuda:0', dtype=torch.float16)
    arg11_1 = rand_strided((640, ), (1, ), device='cuda:0', dtype=torch.float16)
    arg12_1 = rand_strided((640, ), (1, ), device='cuda:0', dtype=torch.float16)
    arg13_1 = rand_strided((640, 640), (640, 1), device='cuda:0', dtype=torch.float16)
    arg14_1 = rand_strided((640, 640), (640, 1), device='cuda:0', dtype=torch.float16)
    arg15_1 = rand_strided((640, 640), (640, 1), device='cuda:0', dtype=torch.float16)
    arg16_1 = rand_strided((640, 640), (640, 1), device='cuda:0', dtype=torch.float16)
    arg17_1 = rand_strided((640, ), (1, ), device='cuda:0', dtype=torch.float16)
    arg18_1 = rand_strided((640, ), (1, ), device='cuda:0', dtype=torch.float16)
    arg19_1 = rand_strided((640, ), (1, ), device='cuda:0', dtype=torch.float16)
    arg20_1 = rand_strided((5120, 640), (640, 1), device='cuda:0', dtype=torch.float16)
    arg21_1 = rand_strided((5120, ), (1, ), device='cuda:0', dtype=torch.float16)
    arg22_1 = rand_strided((640, 2560), (2560, 1), device='cuda:0', dtype=torch.float16)
    arg23_1 = rand_strided((640, ), (1, ), device='cuda:0', dtype=torch.float16)
    arg24_1 = rand_strided((640, 640), (640, 1), device='cuda:0', dtype=torch.float16)
    arg25_1 = rand_strided((640, ), (1, ), device='cuda:0', dtype=torch.float16)
    arg26_1 = rand_strided((1, 32, 640), (20480, 640, 1), device='cuda:0', dtype=torch.float16)
    arg27_1 = 15
    arg28_1 = 45
    arg29_1 = rand_strided((22, 640, 15, 45), (432000, 675, 45, 1), device='cuda:0', dtype=torch.float16)
