...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/om/comqjhzxyqzjlo7umk67mvki7j47mnkqruik56edoyic6jg5kq42.py
...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/fr/cfrpkwtnqgitgcwqmnkinztacmpznfudpunfjf7th5z3fj3s37k5.py
...
def call(args):
    ...
    assert_size_stride(arg2_1, (640, 960, 3, 3), (8640, 9, 3, 1))
    ...
    assert_size_stride(arg16_1, (640, 960, 1, 1), (960, 1, 1, 1))
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg2_1 = rand_strided((640, 960, 3, 3), (8640, 9, 3, 1), device='cuda:0', dtype=torch.float16)
    ...
    arg16_1 = rand_strided((640, 960, 1, 1), (960, 1, 1, 1), device='cuda:0', dtype=torch.float16)
    ...
    arg20_1 = 15
    arg21_1 = 45
    arg22_1 = rand_strided((22, 960, 15, 45), (648000, 675, 45, 1), device='cuda:0', dtype=torch.float16)
