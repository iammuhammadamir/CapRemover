...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/7c/c7c2xyk6hw443v5mcuum3mjjzudvhfqaduzaaqxzbjmwanerq4w3.py
...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/74/c74h574k6z3surcmm6yqnayhnv6iti572q2rijne77asc5s2zph4.py
...
def call(args):
    ...
    assert_size_stride(arg2_1, (1280, 1280, 3, 3), (11520, 9, 3, 1))
    ...
    assert_size_stride(arg18_1, (22, 1280, s1, s2), (1280*s1*s2, s1*s2, s2, 1))
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        assert_size_stride(buf20, (22, 1280, s1, s2), (1280*s1*s2, s1*s2, s2, 1))
        del arg15_1
        del buf19
        buf21 = buf18; del buf18  # reuse
        # Source Nodes: [add_4, mul_2, output_tensor, result_6, result_7], Original ATen: [aten.add, aten.convolution, aten.div, aten.mul]
        triton_poi_fused_add_convolution_div_mul_4_xnumel = 28160*s1*s2
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg2_1 = rand_strided((1280, 1280, 3, 3), (11520, 9, 3, 1), device='cuda:0', dtype=torch.float16)
    ...
    arg16_1 = 8
    arg17_1 = 23
    arg18_1 = rand_strided((22, 1280, 8, 23), (235520, 184, 23, 1), device='cuda:0', dtype=torch.float16)
