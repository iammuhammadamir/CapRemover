...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/c7/cc7mucam2pbmz7bpn447vf7ecenzwol572bwrrxybbd47brn6edx.py
...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/zv/czvulinw2dtmpji3q36bbf6lgfcxufstcpfvivhcp7qkko4qehk3.py
...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/zs/czsdkjy42sunmxlnqlqdvysef7embusvcxmmvexu3lndvxtd4in3.py
...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/d2/cd2w7zftdelavb5xrmecbpv7h7rfwicgv3m5onfyh55pwaxvtstc.py
...
def call(args):
    ...
    assert_size_stride(arg2_1, (640, 320, 3, 3), (2880, 9, 3, 1))
    ...
    assert_size_stride(arg16_1, (640, 320, 1, 1), (320, 1, 1, 1))
    assert_size_stride(arg17_1, (640, ), (1, ))
    assert_size_stride(arg18_1, (64, 320, 1, 1), (320, 1, 1, 1))
    assert_size_stride(arg19_1, (640, 64, 1, 1), (64, 1, 1, 1))
    assert_size_stride(arg22_1, (22, 320, s0, s1), (320*s0*s1, s0*s1, s1, 1))
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        # Source Nodes: [hidden_states_1], Original ATen: [aten.native_group_norm]
        triton_red_fused_native_group_norm_0_rnumel = 10*s0*s1
        stream0 = get_raw_stream(0)
        triton_red_fused_native_group_norm_0.run(arg22_1, buf0, buf1, s0, s1, 704, triton_red_fused_native_group_norm_0_rnumel, grid=grid(704), stream=stream0)
        ps0 = s0*s1
        ps1 = 320*s0*s1
        buf4 = empty_strided_cuda((22, 320, s0, s1), (320*s0*s1, s0*s1, s1, 1), torch.float16)
        # Source Nodes: [hidden_states_1, hidden_states_2], Original ATen: [aten.native_group_norm, aten.silu]
        triton_poi_fused_native_group_norm_silu_1_xnumel = 7040*s0*s1
        triton_poi_fused_native_group_norm_silu_1.run(arg22_1, buf0, buf1, arg0_1, arg1_1, buf4, ps0, ps1, s0, s1, triton_poi_fused_native_group_norm_silu_1_xnumel, grid=grid(triton_poi_fused_native_group_norm_silu_1_xnumel), stream=stream0)
        del arg0_1
        del arg1_1
        ...
        assert_size_stride(buf5, (22, 640, s0, s1), (640*s0*s1, s0*s1, s1, 1))
        del arg2_1
        ...
        assert_size_stride(buf6, (22, 64, s0, s1), (64*s0*s1, s0*s1, s1, 1))
        del arg4_1
        del buf4
        ...
        assert_size_stride(buf7, (22, 640, s0, s1), (640*s0*s1, s0*s1, s1, 1))
        del arg5_1
        del buf6
        ...
        # Source Nodes: [hidden_states_4, hidden_states_5, mul, result, result_1], Original ATen: [aten.add, aten.convolution, aten.mul, aten.native_group_norm]
        triton_red_fused_add_convolution_mul_native_group_norm_3_rnumel = 20*s0*s1
        triton_red_fused_add_convolution_mul_native_group_norm_3.run(buf12, arg3_1, buf7, buf9, arg7_1, buf11, buf13, buf14, s0, s1, ps0, 704, triton_red_fused_add_convolution_mul_native_group_norm_3_rnumel, grid=grid(704), stream=stream0)
        del arg3_1
        del arg7_1
        del buf11
        del buf9
        ...
        assert_size_stride(buf16, (22, 640, s0, s1), (640*s0*s1, s0*s1, s1, 1))
        del arg16_1
        ...
        assert_size_stride(buf17, (22, 64, s0, s1), (64*s0*s1, s0*s1, s1, 1))
        del arg18_1
        del arg22_1
        ...
        assert_size_stride(buf18, (22, 640, s0, s1), (640*s0*s1, s0*s1, s1, 1))
        del arg19_1
        del buf17
        ps2 = 640*s0*s1
        buf20 = buf7; del buf7  # reuse
        # Source Nodes: [hidden_states_5, hidden_states_6], Original ATen: [aten.native_group_norm, aten.silu]
        triton_poi_fused_native_group_norm_silu_4_xnumel = 14080*s0*s1
        triton_poi_fused_native_group_norm_silu_4.run(buf12, buf13, buf14, arg10_1, arg11_1, buf20, ps0, ps2, s0, s1, triton_poi_fused_native_group_norm_silu_4_xnumel, grid=grid(triton_poi_fused_native_group_norm_silu_4_xnumel), stream=stream0)
        del arg10_1
        del arg11_1
        del buf12
        del buf13
        ...
        assert_size_stride(buf21, (22, 640, s0, s1), (640*s0*s1, s0*s1, s1, 1))
        del arg12_1
        ...
        assert_size_stride(buf22, (22, 64, s0, s1), (64*s0*s1, s0*s1, s1, 1))
        del arg14_1
        del buf20
        ...
        assert_size_stride(buf23, (22, 640, s0, s1), (640*s0*s1, s0*s1, s1, 1))
        del arg15_1
        del buf22
        buf24 = buf16; del buf16  # reuse
        # Source Nodes: [add_5, mul_2, mul_3, output_tensor, result_10, result_6, result_7, result_9], Original ATen: [aten.add, aten.convolution, aten.div, aten.mul]
        triton_poi_fused_add_convolution_div_mul_5_xnumel = 14080*s0*s1
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg2_1 = rand_strided((640, 320, 3, 3), (2880, 9, 3, 1), device='cuda:0', dtype=torch.float16)
    ...
    arg16_1 = rand_strided((640, 320, 1, 1), (320, 1, 1, 1), device='cuda:0', dtype=torch.float16)
    arg17_1 = rand_strided((640, ), (1, ), device='cuda:0', dtype=torch.float16)
    arg18_1 = rand_strided((64, 320, 1, 1), (320, 1, 1, 1), device='cuda:0', dtype=torch.float16)
    arg19_1 = rand_strided((640, 64, 1, 1), (64, 1, 1, 1), device='cuda:0', dtype=torch.float16)
    arg20_1 = 15
    arg21_1 = 45
    arg22_1 = rand_strided((22, 320, 15, 45), (216000, 675, 45, 1), device='cuda:0', dtype=torch.float16)
