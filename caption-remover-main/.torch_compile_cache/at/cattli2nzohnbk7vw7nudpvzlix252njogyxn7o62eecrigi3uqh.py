...
# kernel path: /workspace/caption-remover-main/src/stages/inpaint/../../../.torch_compile_cache/an/can4qjgu2fzxhteolg5eurvyoszrlkyymlspibffnpvlegktd7fl.py
...
def call(args):
    ...
    assert_size_stride(arg6_1, (22, 1280, s1, s2), (1280*s1*s2, s1*s2, s2, 1))
    with torch.cuda._DeviceGuard(0):
        ...
        assert_size_stride(buf0, (22, 1280, 1 + (((-1) + s1) // 2), 1 + (((-1) + s2) // 2)), (1280 + (1280*(((-1) + s1) // 2)) + (1280*(((-1) + s2) // 2)) + (1280*(((-1) + s1) // 2)*(((-1) + s2) // 2)), 1 + ((((-1) + s1) // 2)*(((-1) + s2) // 2)) + (((-1) + s1) // 2) + (((-1) + s2) // 2), 1 + (((-1) + s2) // 2), 1))
        del arg0_1
        ...
        assert_size_stride(buf2, (22, 1280, 1 + (((-1) + s1) // 2), 1 + (((-1) + s2) // 2)), (1280 + (1280*(((-1) + s1) // 2)) + (1280*(((-1) + s2) // 2)) + (1280*(((-1) + s1) // 2)*(((-1) + s2) // 2)), 1 + ((((-1) + s1) // 2)*(((-1) + s2) // 2)) + (((-1) + s1) // 2) + (((-1) + s2) // 2), 1 + (((-1) + s2) // 2), 1))
        del arg3_1
        del buf1
        ps0 = (1 + (((-1) + s1) // 2))*(1 + (((-1) + s2) // 2))
        buf3 = reinterpret_tensor(buf0, (22, 1280, 1 + (((-1) + s1) // 2), 1 + (((-1) + s2) // 2)), (1280 + (1280*(((-1) + s1) // 2)) + (1280*(((-1) + s2) // 2)) + (1280*(((-1) + s1) // 2)*(((-1) + s2) // 2)), 1 + ((((-1) + s1) // 2)*(((-1) + s2) // 2)) + (((-1) + s1) // 2) + (((-1) + s2) // 2), 1 + (((-1) + s2) // 2), 1), 0); del buf0  # reuse
        # Source Nodes: [mul, result, result_1], Original ATen: [aten.add, aten.convolution, aten.mul]
        triton_poi_fused_add_convolution_mul_0_xnumel = 28160 + (28160*(((-1) + s1) // 2)) + (28160*(((-1) + s2) // 2)) + (28160*(((-1) + s1) // 2)*(((-1) + s2) // 2))
