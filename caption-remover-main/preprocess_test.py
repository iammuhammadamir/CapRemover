...
def main():
    ...
    print("=" * 60)
    # Adjust ROI for the new video dimensions (900x1600)
    # Original was for 1080x1920, scale accordingly
    roi = (145, 700, 600, 180)   # (x, y, width, height) for caption region scaled to 900x1600
    visualize_roi(processed_video, roi, frame_idx=300)
